...
description: Beginner guide to mobile screen math: PPI, logical pixels, iOS pt and Android dp scaling, plus Photoshop canvas setups for iPhone, Android, and web.
image:
date: 2015-04-19 19:55:00
categories: 折腾与思考-Geek
tags: ["Design", "Tutorial", "UI", "Mobile", "Technology"]
url: /post-en/3435
translationKey: '3435'
---
...
![Macro shot of RGB pixel grid on an LCD screen displaying text](https://cdn.victor42.work/posts/2015-04/04-17/1.jpg)
...
![PPI conceptual diagram illustrating a 9x9 pixel grid in a 1x1 inch area](https://cdn.victor42.work/posts/2015-04/04-17/2.png)
...
![UI size comparison of iPhone 3GS and 4S without scaling factors applied](https://cdn.victor42.work/posts/2015-04/04-17/3.png)
...
![Diagram comparing logical pixels and physical pixels in iPhone 3GS and 4S](https://cdn.victor42.work/posts/2015-04/04-17/5.png)
...
![Scaling factors of three common Android screen resolutions to logical pixels](https://cdn.victor42.work/posts/2015-04/04-17/6.png)
...
![Official Android screen size and density classification matrix table](https://cdn.victor42.work/posts/2015-04/04-17/4.png)
...
![Umeng statistics bar chart of mainstream Android resolutions from 2014 to 2015](https://cdn.victor42.work/posts/2015-04/04-17/7.png)
...
![Photoshop Units and Rulers settings dialog with rulers and type set to Points](https://cdn.victor42.work/posts/2015-04/04-17/8.png)
...
![Photoshop Image Size dialog setting resolution to 144 DPI for 2x scale rendering](https://cdn.victor42.work/posts/2015-04/04-17/9.png)
