...
description: "A complete guide to decentralizing a blog with Web3: ENS domain resolution, IPFS content addressing, and migrating off traditional hosting."
image: https://cdn.victor42.work/posts/2022-02/IPFS.jpg
date: 2022-02-19 21:47:00
categories: 折腾与思考-Geek
tags: ["Blockchain", "Technology", "Tutorial", "Science", "ENS", "IPFS"]
url: /post-en/3608
translationKey: '3608'
---

I've moved my blog to the blockchain. It might look like a simple theme change, but there's a lot more going on under the hood.
...
![Close-up photograph of cloud server racks in a traditional Web2 data center, showing rows of black server cabinets with blinking indicator lights and network cables, representing the physical infrastructure that hosts websites on the conventional internet](https://cdn.victor42.work/posts/2022-02/taylor-vick-M5tzZtFCOfs-unsplash.jpg)
...
![Educational diagram breaking down the structure of a URL, highlighting the four components of http://www.baidu.com: protocol, subdomain, main domain, and top-level domain, with arrows pointing to each section for clear visual explanation](https://cdn.victor42.work/posts/2022-02/Domain-Explanation-2.12.2019-02.jpg)
...
![URL structure diagram with the com top-level domain section highlighted in orange, explaining that TLDs categorize websites by purpose such as company, education, or military, and are controlled by the international organization ICANN](https://cdn.victor42.work/posts/2022-02/Domain-Explanation-2.12.2019-02.jpg)
...
![URL structure diagram highlighting the baidu main domain section in orange, explaining that the main domain combined with the top-level domain forms a complete address controlled by domain registrars and cloud service providers](https://cdn.victor42.work/posts/2022-02/Domain-Explanation-2.12.2019-02.jpg)
...
![URL structure diagram with the www subdomain section highlighted in orange, explaining that subdomains like www represent World Wide Web and can be freely created by the main domain owner to point to different services](https://cdn.victor42.work/posts/2022-02/Domain-Explanation-2.12.2019-02.jpg)
...
![Product photograph of a Tianqiang TR261F tower server hardware unit, showing a black metal chassis with front panel drive bays and ventilation grilles, representing the type of physical server that can be self-hosted in an office](https://cdn.victor42.work/posts/2022-02/天强TR261F.jpg)
...
![Screenshot of the ENS blockchain domain registration website search page, showing the interface where users can search for and purchase .eth domains, with a search bar and domain availability results displayed on a clean white background](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-17-下午 3.26.59.jpg)
...
![ENS dashboard screenshot showing the blockchain ownership record details for the victor42.eth domain, displaying the wallet address that owns the domain and the registration expiration date on a dark themed interface](https://cdn.victor42.work/posts/2022-02/Snipaste_2022-02-19_22-53-11.jpg)
...
![Comparison diagram illustrating the difference between the traditional information transmission web and the blockchain value network, showing how traditional networks require intermediaries like UnionPay while blockchain networks verify value transfer directly through cryptography](https://cdn.victor42.work/posts/2022-02/v2-1c7c39a838509163666786299a1aaa0c_1440w.jpg)
...
![Screenshot of a cryptocurrency wallet interface displaying a long hexadecimal Ethereum address, showing the complex string of characters that represents a wallet account on the blockchain network](https://cdn.victor42.work/posts/2022-02/Screen-Shot-2018-06-29-at-6.00.20-PM.jpg)
...
![Official logo and icon of the InterPlanetary File System (IPFS), featuring a distinctive geometric honeycomb-like network pattern in blue and white colors, representing the decentralized storage technology](https://cdn.victor42.work/posts/2022-02/IPFS.jpg)
...
![Diagram illustrating how IPFS distributes data across multiple nodes using sharding and hash validation, showing how files are broken into pieces and stored across a decentralized network with cryptographic verification](https://cdn.victor42.work/posts/2022-02/Snipaste_2022-02-19_23-09-55.jpg)
...
![Screenshot of a BitTorrent client window showing peer-to-peer file downloads in progress, displaying multiple seed connections and transfer speeds, illustrating the distributed network technology that inspired IPFS](https://cdn.victor42.work/posts/2022-02/18aebc5f0c14c27bc4ccc13a2a46b7b1eff939e1.jpg)
...
4.  **Tamper-proof:** Each piece of content has a unique code. Tampering creates a new code. The original code always leads to the original content, making it ideal for recording information age history, avoiding the [digital dark age](https://victor42.eth.limo/post-en/3584/).
...
![Technical comparison diagram showing the difference between IPFS content addressing and traditional network location addressing, with visual representations of how each method retrieves data from the network](https://cdn.victor42.work/posts/2022-02/1_QVpq6pw2gbbtCmVybBrEuA.jpg)
...
![Scientific concept diagram showing solar conjunction interference with Mars space probes, illustrating how the sun blocks communication between Earth and Mars spacecraft during certain orbital positions](https://cdn.victor42.work/posts/2022-02/de4c7603471048a69eea26092fa89d0f.jpg)
...
![Screenshot of the Fleek decentralized platform Storage dashboard showing uploaded assets and file management interface, where users can upload files to IPFS and get shareable links](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-18-下午 4.51.35.jpg)
...
![Screenshot of the Fleek Hosting page showing the step-by-step process to link a GitHub account for decentralized website deployment on IPFS](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-18-下午 4.52.01.jpg)

Then choose your static website system.

![Screenshot of the Fleek configuration page showing the selection of Hugo as the static site build framework for deploying a blockchain website on IPFS](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-18-下午 4.43.25.jpg)
...
![Screenshot of the Fleek network selection page showing the choice to deploy the website on the decentralized IPFS network rather than other blockchain options](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-18-下午 4.52.36.jpg)
...
![Screenshot of the Fleek deploy log showing a successful website build on IPFS, displaying the deployment status and the generated IPFS content hash for the blockchain website](https://cdn.victor42.work/posts/2022-02/截屏 2022-02-18-下午 4.53.17.jpg)
...
![Multi-row flow chart comparing DNS and ENS routing paths, showing three scenarios: traditional website routing, traditional domain with blockchain website, and blockchain domain with blockchain website using IPFS](https://cdn.victor42.work/posts/2022-02/processed-faef701d-d810-454e-bef5-5b4b69f5597a_1d9a7f02-b98e-4f64-b034-aeac075ca384.jpg)
...
![Photograph of an ultra-long white Lincoln stretch limousine car parked outdoors, used to humorously explain the meaning of the .limo top-level domain in blockchain naming](https://cdn.victor42.work/posts/2022-02/limousinerental1518120210.jpg)
