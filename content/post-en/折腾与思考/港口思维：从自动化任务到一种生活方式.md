...
description: "Defines a port mindset with demurrage-style buffers for files, tabs, packages, money, and thoughts, using Tasker, File Juggler, and Tab Wrangler cleanups."
image: https://cdn.victor42.work/posts/2023-01/chuttersnap-xewrfLD8emE-unsplash.jpg
date: 2023-01-12 23:52:00
categories: 折腾与思考-Geek
tags: ["Automation", "Efficiency", "Philosophy", "Method", "Daily Life"]
url: /post-en/3627
translationKey: '3627'
---

Inspired by ports, a new perspective on how things and thoughts flow in life.
...
![Screenshot of cluttered computer desktop with blue starry sky background, hundreds of file and folder icons densely arranged including PDFs/games/documents/shortcuts](https://cdn.victor42.work/posts/2023-01/25483758823_4ef46dc7e1_o.jpg)
...
![To-do completion screen screenshot with orange-yellow hot air balloon illustration on white background, text below reads All tasks for today are completed! Enjoy your empty inbox.](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-21-44.jpg)
...
![Aerial night photo of busy shipping port, thousands of containers densely stacked, multiple yellow gantry cranes operating, lights illuminating the entire port area](https://cdn.victor42.work/posts/2023-01/chuttersnap-xewrfLD8emE-unsplash.jpg)
...
![Top-bottom comparison image, top shows express packages piled up outdoors, bottom shows scrap metal heap piled up, demonstrating consequences of buffer zone being used as garbage dump](https://cdn.victor42.work/posts/2023-01/3wg83jbos.jpg)
...
![Microsoft To Do app interface screenshot, left tablet shows Work/Home/Groceries category lists, right phone shows Groceries list with Milk/Apples/Frozen pizza items](https://cdn.victor42.work/posts/2023-01/RE3HTxG.jpg)
...
![Android phone File Manager screenshot, red circle highlights 0#FilePort folder with 3 items, below lists 0#Music/0#Resilio/Alarms/alipay/amap folders](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112_144709.jpg)
...
![Tasker automation app settings screenshot showing three toggles: Auto move download directory/Auto move WeChat download directory/Auto move audio output directory, all enabled](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112-144251.jpg)
...
![Tasker automation app settings screenshot showing Daily cleanup specific directory toggle enabled, time set to 3:00AM to execute cleanup specific directory task](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112-144325.jpg)
...
![Tasker task edit interface screenshot, title Cleanup specific directory, red circle highlights Variable Set step, parameter 1 set to %PathFilePort, parameter 2 set to 604800 seconds i.e. 7 days](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112_144823.jpg)
...
![Android phone File Manager screenshot showing PhoneRecord folder with call recording file list, each file in aac format, size from 99KB to 689KB, dates from 2022](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112-145049.jpg)
...
![Tasker task edit interface screenshot, red circle highlights Variable Set step, parameter 1 set to %PathCallRecord, parameter 2 set to 100000 bytes i.e. 100KB, for cleaning small files](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112_144905.jpg)
...
![Dropsync folder pair settings screenshot, Remote folder set to /archive/电话录音, Local folder set to [Internal storage]/Record/PhoneRecord, sync method Two-way](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112-145129.jpg)
...
![Windows 11 desktop screenshot with Saturn ring wallpaper background, only Recycle Bin icon on desktop, taskbar shows Edge/File Manager/Mail apps](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-52-38.jpg)
...
![File Juggler auto cleanup rule settings screenshot, Description is Empty download, Monitor monitors download folder, If condition is Date modified Older than 18 Hours ago, Then action is Send file to recycle](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-54-02.jpg)
...
![PC WeChat File Transfer Assistant chat window screenshot, red box highlights scissors screenshot button in bottom toolbar](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-56-00.jpg)
...
![Snipaste screenshot tool preferences interface screenshot, Output tab with Auto Save checked enabled, Path set to D:/Resilio/screenshots/Snipaste_$yyyy-MM-dd_HH-mm-ss.png](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-57-15.jpg)
...
![Resilio Sync screenshot comparison, left Sync Home Pro shows screenshots folder status normal 1/3 online users, right phone Folders interface shows screenshots folder Peers: 1](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_14-58-56.jpg)
...
![Tasker task edit interface screenshot, red circle highlights Variable Set step, parameter 1 set to %PathSyncScreenshots, parameter 2 set to 604800 seconds i.e. 7 days, for cleaning expired screenshots](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112_144849.jpg)
...
![Browser tab bar screenshot showing about 20 densely packed tabs including Google Search/Gmail/YouTube/Documents icons](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_15-00-47.jpg)
...
![Tab Wrangler browser plugin settings interface screenshot, Close inactive tabs if over 720 minutes 0 seconds, Auto close tabs only when more than 5 tabs opened, Remember up to 100 closed tabs](https://cdn.victor42.work/posts/2023-01/Snipaste_2023-01-12_15-02-18.jpg)
...
![White paper bag hanging on hook behind door, with handwritten Inbox text and envelope icon on it, for storing time-sensitive paper documents](https://cdn.victor42.work/posts/2023-01/IMG_20230112_103422.jpg)
...
![China Merchants Bank app fund collection settings screenshot showing two rules: Daily minimum balance collection from CITIC Bank to CMB, Daily smart collection from CCB minimum 5000 yuan maximum 20000 yuan to CMB](https://cdn.victor42.work/posts/2023-01/Screenshot_20230112-150344.jpg)
