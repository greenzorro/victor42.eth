...
description: "Building a cellular automaton simulator inspired by Kevin Kelly's Out of Control: demonstrating emergence, decentralized systems, and swarm intelligence."
image:
date: 2014-01-30 15:00:00
categories: 折腾与思考-Geek
tags: ["Book Review", "Technology", "Science", "Programming", "Tutorial"]
url: /post-en/3085
translationKey: '3085'
---
...
[![Initial random matrix of teal and brown dots in the chaos simulator](https://cdn.victor42.work/posts/2014-01/01-30/1.png)](http://greenzorro.github.io/chaos/)
...
![Stable evolved dot pattern in a 10x20 grid with connection level of 1](https://cdn.victor42.work/posts/2014-01/01-30/2.png)
...
![Regular polarized pattern with a higher connection level of 3 in the simulator](https://cdn.victor42.work/posts/2014-01/01-30/3.png)
...
![Simulator pattern showing isolated islands in a 20x30 grid with connection level 1](https://cdn.victor42.work/posts/2014-01/01-30/4.png)
...
![Simulator pattern with connection level 3 where isolated islands are eliminated](https://cdn.victor42.work/posts/2014-01/01-30/5.png)
...
![A uniform single-color evolved pattern in a 20x30 grid with connection level 3](https://cdn.victor42.work/posts/2014-01/01-30/6.png)
