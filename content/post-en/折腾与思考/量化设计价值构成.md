...
![A comprehensive spreadsheet dashboard showing design value and business structure](https://cdn.victor42.work/posts/2023-10/a9a5b3988a8c913ff30d990b21313263.png)
...
![A schedule planner in calendar tool showing design tasks for October](https://cdn.victor42.work/posts/2023-10/b7cb270372f19fd67879c57bd8a7b009.jpg)
...
![A raw data table in spreadsheet containing design project durations](https://cdn.victor42.work/posts/2023-10/65d4321bfa13f03090b90554cad84bd6.png)
...
![Worksheet tabs at the bottom of a spreadsheet workbook](https://cdn.victor42.work/posts/2023-10/5d8953d9788ad3b0997eea965fec52e6.png)
...
![A pivot table in spreadsheet summarizing durations for each business line](https://cdn.victor42.work/posts/2023-10/ab35313c1c52dc5c5328490034a68dbd.png)
...
![The PivotTable Fields setup panel and dragging area](https://cdn.victor42.work/posts/2023-10/b790a28d8fc8fc1ad15ecb4b726112eg.png)

The left pivot table: filter for a specific designer (me), list each requester as a row, and sum the durations.

![Summarizing business durations using a pivot table in spreadsheet](https://cdn.victor42.work/posts/2023-10/ab35313c1c52dc5c5328490034a68dbd.png)

The right table lists the major business lines, selects corresponding requesters from the left table, and sums the totals.

![The GETPIVOTDATA formula bar in spreadsheet for pivot table values](https://cdn.victor42.work/posts/2023-10/0d9aec6a5807c7ba9153da8f20b261a1.png)
...
![Five different pivot tables analyzing design value dimensions](https://cdn.victor42.work/posts/2023-10/e0a5d1274532853173f10402d53d9d06.png)
...
![Dragging Business and Duration fields in the PivotTable Fields pane](https://cdn.victor42.work/posts/2023-10/4b7fd4d8f38266dc59903bddfa4dc4d2.png)

Table 1: each business line is a row, and durations are summed.

![Selecting percentage of column total display in value field settings](https://cdn.victor42.work/posts/2023-10/187174f765fd78ba42d098c00b301d92.png)
...
![An analysis of design value using five separate pivot tables](https://cdn.victor42.work/posts/2023-10/e0a5d1274532853173f10402d53d9d06.png)
...
![Dragging Value and Business fields to rows area in PivotTable](https://cdn.victor42.work/posts/2023-10/d68bb255437ef1e63a9386d499ce48e4.png)
...
![Aggregating design value data in multi-dimensional pivot tables](https://cdn.victor42.work/posts/2023-10/e0a5d1274532853173f10402d53d9d06.png)
...
![A design work value dashboard using treemap and pie charts](https://cdn.victor42.work/posts/2023-10/a9a5b3988a8c913ff30d990b21313263.png)
...
![Checking Category Name and Value in Format Data Labels pane](https://cdn.victor42.work/posts/2023-10/a85c0e8de3b950ff50c3771a36666c8e.png)
