...
![词根相同但重音不同的四个英语单词](https://cdn.victor42.work/posts/2024-07/70c28efdcd37e6d4a143ff2df66084be.jpg)
...
![包含基础进阶和专家三阶段技能清单](https://cdn.victor42.work/posts/2024-07/7486fc8650cedd8b8b4f7816e9af7e0d.jpg)
...
![以字母开头的数据集原始英文单词列表](https://cdn.victor42.work/posts/2024-07/035173524c2057e2515c255add081cea.jpg)

一个txt文件有4mb，看小说的人应该熟悉，这可是百万字级别的小说。

![数据框信息显示包含三十六万多行数据](https://cdn.victor42.work/posts/2024-07/6d8b49da96f58a5292d53296bf7966ba.jpg)
...
![免费在线词典接口返回的单词定义结果](https://cdn.victor42.work/posts/2024-07/5c311b367a15d50faa8f53f724821a54.jpg)

API返回的信息里，除了音标，还有发音的音频、词源、词性、意思和例句。这里可能有用的是音标、词源和词性。但绝大多数词源缺失，只拿了音标和词性。

![词典接口限制五分钟请求四百五十次代码](https://cdn.victor42.work/posts/2024-07/12f254a9769f985b4cacc3b3992a7577.jpg)
...
![卡歌目录下分块保存的英文单词数据文件](https://cdn.victor42.work/posts/2024-07/4a9c399f7966ab61cf767f7712e209d9.jpg)

好吧，3天就3天吧。但做法得改了，要加一个分块查询、阶段性保存的功能。每查了1000行，就存到一个文件里，编上序号。下次按照序号继续查，全部查完再把这300多个文件合并成一张大表。

![电子表格合并后的单词与发音及词性列表](https://cdn.victor42.work/posts/2024-07/22b28704556d17baf1c0c141d5ae3e96.jpg)
...
![代码中处理非常规音标字符的映射规则](https://cdn.victor42.work/posts/2024-07/82acc141ccd3150e4bf0fd08ae292149.jpg)

合并文件后发现，词典查出的音标符号乱七八糟，许多不常见的符号混在其中，比如 `ɘ`, `ɝ`, `ɚ`, `ɨ`, `ʉ`。它们是标准音的变体，在表示更精确的发音时会用到，近似等同与标准音。这些得替换掉，否则会影响音节数和后续所有分析。

![代码中合并同音异写常见音标字符的规则](https://cdn.victor42.work/posts/2024-07/9d9304e6642b5df50354c06d739eea1d.jpg)
...
![词典接口返回的算盘错误且不完整音标](https://cdn.victor42.work/posts/2024-07/627162599344331488dc70237ce660a6.jpg)

后来发现，词典API有少量数据本身就不对。比如算盘（abacus）的发音，/-saɪ/，什么鬼？信息不完整。

![不完整音标单词数量及所占百分比统计](https://cdn.victor42.work/posts/2024-07/f4f3ef7e088114e942d95246bf273902.jpg)
...
![卡歌模型页面中搜索文本大语言模型结果](https://cdn.victor42.work/posts/2024-07/c77ef4414f82188785924057cfe3bc34.jpg)
...
![谷歌表格中应用大模型公式自动分析重音](https://cdn.victor42.work/posts/2024-07/3a5d9b8fcbd23a0d5487891310921f63.jpg)
...
![谷歌表格大模型插件运行费用估算页面](https://cdn.victor42.work/posts/2024-07/81f435b62db92e70d47f0d77841e5703.jpg)
...
![代码中定义的单元音双元音及三元音集合](https://cdn.victor42.work/posts/2024-07/93fc699338026ae0a224090ea716d17c.jpg)
...
![英文歌曲视频中含有三重元音单词歌词](https://cdn.victor42.work/posts/2024-07/d0227a8fc72ffd41ff020f6fceb73b12.jpg)
...
![电子表格中得到的单词音节与重音位置表](https://cdn.victor42.work/posts/2024-07/ba10765865fa9f86332e78b71807279f.jpg)
...
![数据框中初步加载的英语音节与重音表格](https://cdn.victor42.work/posts/2024-07/6bf1e239c52df87ca7159c81c23911cd.jpg)

观察数据表，里面有一些词没有重音。这是因为单词比较短，音标里没有重音符号，把这些排除掉。再排除掉只有一个音节的单词，这重音即使有，位置也实在是没什么好分析的。

![清洗筛选后包含两万多个有效单词数据框](https://cdn.victor42.work/posts/2024-07/99b768328e8403852edad5bbe1d47def.jpg)
...
![有效单词音节数分布柱状图统计分析结果](https://cdn.victor42.work/posts/2024-07/e6ded1b89391ef9844e28f8d4342c3da.jpg)

并不意外，音节数越少，单词数越多。一门语言的演变，当然是先把好用好记的短单词用完了，再去造更长的词。

![不同音节长度英文单词数量占比饼状图](https://cdn.victor42.work/posts/2024-07/9655926ed67e4cb11ee3f8a0ba62cbe0.jpg)

双音节单词占了48.7%，三音节单词占了31.3%。

![四到五个音节以内单词占比文字统计结果](https://cdn.victor42.work/posts/2024-07/20a81644b6c29b8bab1ccc0b79f5e220.jpg)

4个及以内音节的单词占总数的94.73%，5个及以内的单词占总数的99%。

![超长英语单词反政教分离主义音节数计算](https://cdn.victor42.work/posts/2024-07/963d18455de407866b97e9459de20bab.jpg)

音节数最多的单词竟然有11个音节。

![剑桥词典中反政教分离主义单词释义截图](https://cdn.victor42.work/posts/2024-07/79fac98a54c6d574e0c2e29ef224e1dd.jpg)
...
![单词音节长度与重音位置的相关系数结果](https://cdn.victor42.work/posts/2024-07/de6dd89e6d5f9344dc7788051d2266b0.jpg)
...
![音节长度与重音位置分布关系的气泡图](https://cdn.victor42.work/posts/2024-07/424a2fdcade241c75ba5a53eabda74ee.jpg)
...
![各音节长度单词重音位置频数分布分组图](https://cdn.victor42.work/posts/2024-07/8a8e9b114c1ec9758b4c00e62f8be6f6.jpg)

又画了一个复合柱状图，纵轴音节数，横轴重音位置。现在一目了然，重音的分布像海浪一样向右移动，而且似乎真的集中在倒数第三个音节附近。

### 重音音节分析

![数据表重音位置处元音音素的去重列表](https://cdn.victor42.work/posts/2024-07/a8cbd78d2abfeeb6f6a12e95dee24c99.jpg)

列出所有在重音位置的元音。其中一两个本不该作为元音出现在这儿，但检查了原始数据，发现词典本身数据就错了，且数量极少，对结果影响不大。

![元音音素在单词重音位置出现频数排行榜](https://cdn.victor42.work/posts/2024-07/078bec4b5063d84f7f328e910dd61f9a.jpg)
...
![数据集中不同词性单词数量分布排行榜](https://cdn.victor42.work/posts/2024-07/627f810c2d8d6b27501d19d8ad6cff43.jpg)
...
![四类主要词性单词重音位置分布关系热力图](https://cdn.victor42.work/posts/2024-07/ea6d9ff8fee7f0f2477d458be8c4a952.jpg)
...
![数据框中新增用于检验重音位置猜想的列](https://cdn.victor42.work/posts/2024-07/da8aadd06591c811ed2f67ee0b15503d.jpg)

取音节数是4和5的单词，在数据表里专门增加一列，用重音实际位置减去假象位置（倒数第3个）。这列的值可以用来分析单词重音位置是否符合我的猜想，为0则符合，为1则偏后一个音节，-1则偏前，以此类推。

![符合重音位置猜想的单词占比统计结果](https://cdn.victor42.work/posts/2024-07/2695209758cd7525a2d0e71e4dbb4f85.jpg)

符合猜想的单词，比例占43.9%。

![实际重音与预测重音位置偏差分布图](https://cdn.victor42.work/posts/2024-07/5740e6b95198a01806d2831c73cbd1f3.jpg)
...
![扩大样本后符合重音位置猜想的单词占比](https://cdn.victor42.work/posts/2024-07/6048650203a8efe7f09b9d6b3cc270c6.jpg)

符合猜想的单词，比例占43.92%。嗯，没变多少。

![扩大样本后重音偏差分布情况统计柱状图](https://cdn.victor42.work/posts/2024-07/7baa190c8f4aeb3fd58ede643840201d.jpg)
