...
![卖AI图，从开单到金盆洗手：AI生成的国风武侠双人插图银发女与红发男侧脸相对](https://cdn.victor42.work/posts/2025-05/1cc02c0bc68a362b1d44b4de01416be3.webp)

拿我在其他项目中的对比结果举例。上图是Flux dev画的，完美地遵循了我对人物外貌的要求：女主青绿色衣服、银灰色长发；男主红色衣服，红色头发。甚至人物的眼珠颜色都遵照了指令。

![卖AI图，从开单到金盆洗手：AI生成的古风言情插图紫发公子与银发女子古殿亲吻](https://cdn.victor42.work/posts/2025-05/86a1c4af1b2e365cca75a7e595885a4b.webp)
...
![卖AI图，从开单到金盆洗手：用于AI生图的ComfyUI复杂节点批量生产工作流全局截图](https://cdn.victor42.work/posts/2025-05/8aec8fc0f480daac85a741fa5a288536.webp)
...
![卖AI图，从开单到金盆洗手：Replicate与RunComfy两个AI云算力平台的品牌标志对比](https://cdn.victor42.work/posts/2025-05/6b5e8f6f5c09ef4fc1957a61d0c9e7e1.webp)
...
![卖AI图，从开单到金盆洗手：Replicate平台flux-dev-lora模型每张图收费0.032美元的定价页](https://cdn.victor42.work/posts/2025-05/5fac174ef96e1fe4a297ab6365c802e7.webp)
...
![卖AI图，从开单到金盆洗手：ComfyUI中用于高清放大的TTP分块放大节点工作流截图](https://cdn.victor42.work/posts/2025-05/3117969428b59e24d262d922b13bdc61.webp)
...
![卖AI图，从开单到金盆洗手：RunComfy云端GPU平台Hobby与Pro套餐价格对比页面](https://cdn.victor42.work/posts/2025-05/0840c3aec7006ee08ce2b68bef26b2b1.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的儿童绘本平涂与素描两种风格母亲男孩水仙花对比](https://cdn.victor42.work/posts/2025-05/4abb55973b10dfc1491328b0499e6de5.webp)

#### 挑战1：满足风格要求

刚开始我偷了点懒，认为客户对风格的要求没有那么高，没有专门训练风格模型，而是去AI社区找别人的模型来用。生成了几次，客户对水彩风格勉强接受，但认为扁平风格和他们的参考图差异太大。

![卖AI图，从开单到金盆洗手：AI生成的两版儿童绘本插图平涂和水彩风格母子赏花场景](https://cdn.victor42.work/posts/2025-05/776493c1430edf9a9a4f3e761fd69565.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的水彩风格儿童绘本插图母亲抓住男孩手臂水仙花旁](https://cdn.victor42.work/posts/2025-05/86958314b04e57621321225218a9be95.webp)
...
![卖AI图，从开单到金盆洗手：ComfyUI平涂风格儿童绘本角色Prompt提示词文本详细截图](https://cdn.victor42.work/posts/2025-05/becc19b993c3f1b05d05fceb0724da4d.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的儿童绘本插图带红框标注手部和花朵存在的问题](https://cdn.victor42.work/posts/2025-05/8aa627aa4a1c69576aa845f4bedda2a1.webp)
...
![卖AI图，从开单到金盆洗手：Liblib平台用于训练AI绘图风格Lora的模型微调参数设置界面](https://cdn.victor42.work/posts/2025-05/baf0661304498451e79dedadb36305ff.webp)
...
![卖AI图，从开单到金盆洗手：项目中运行RunComfy工作流所需的API配置JSON文件列表](https://cdn.victor42.work/posts/2025-05/50c317a3a943f4063fbdfcb904aa4c98.webp)

这样就准备好了两套生图工作流，一套水彩风格，一套扁平风格。分别导出API格式文件，留待程序调用。

另一个核心工作流是高清放大。本质是基础的Flux图生图工作流，但有这几个区别：

![卖AI图，从开单到金盆洗手：ComfyUI平涂儿童绘本生图工作流含四步Lora与低降噪值节点](https://cdn.victor42.work/posts/2025-05/06a64ad801e05bf0bb897a520b5a798b.webp)
...
![卖AI图，从开单到金盆洗手：用于AI生图参考的中国传统玉石浮雕迎客松仙鹤纹饰挂画](https://cdn.victor42.work/posts/2025-05/bc4688a79ca948cd18247bf19f64b975.webp)
...
![卖AI图，从开单到金盆洗手：ComfyUI局部重绘工作流标注风格Lora修手Lora与Flux fill节点](https://cdn.victor42.work/posts/2025-05/420eff7d539ee0d57ffe31a0e2d71865.webp)

**文生图局部重绘**，用的是Flux dev fill模型，这个模型是专门用来局部重绘和扩图的。工作流其他方面和基础文生图一样，只是还挂了我训练的风格Lora。当需要给人物加一顶帽子、换双鞋子，改改猫尾巴的形状，就用这个工作流。

![卖AI图，从开单到金盆洗手：ComfyUI卡通风格局部Inpaint工作流含Flux redux图像参考模块](https://cdn.victor42.work/posts/2025-05/371178a155b572a71eac5496cafde7f1.webp)
...
![卖AI图，从开单到金盆洗手：ComfyUI含图像输入预处理模块的Flux redux图像参考生图工作流](https://cdn.victor42.work/posts/2025-05/d61012dafe242e5c5c8a12f9061b1e11.webp)
...
![卖AI图，从开单到金盆洗手：VSCode中儿童绘本自动化AI生图项目的Python脚本文件目录](https://cdn.victor42.work/posts/2025-05/7ba00f10d5baba852b7ecf192d626828.webp)
...
![卖AI图，从开单到金盆洗手：Notion数据库AI生图工作流的图片表人设表项目表三级结构](https://cdn.victor42.work/posts/2025-05/b20bc439ab6eb3605ca35d5f9f84dacb.webp)

我的表格结构有点复杂，从上到下有图片表、人设表、项目表3层，另外还有两张维度表，用来定义两种风格的提示词和图片复杂度等级（不同复杂度价格不同）。上层表依赖下层表，从下层表中读取数据。下层表汇总上层表，用以统计图片量、估算营收。

![卖AI图，从开单到金盆洗手：Notion项目表Finished视图展示调试实测项目与完成状态记录](https://cdn.victor42.work/posts/2025-05/cbd58340ff222763cccda062c237bd5d.webp)

从下往上讲。基础是项目表，定义了项目名称、所属月份、图片风格，汇总计算图片数量，根据每张图的复杂度去需求类型表里查出价格并求和，估算整个项目营收，同时也记录一些备注性质的信息。

![卖AI图，从开单到金盆洗手：Notion图片表Grid视图显示项目15下82条带缩略图的图片记录](https://cdn.victor42.work/posts/2025-05/ce6e669c0e3371bb8b89c75df1b38d32.webp)
...
![卖AI图，从开单到金盆洗手：Notion图片表展示角色一角色二字段与对应AI人设提示词关联](https://cdn.victor42.work/posts/2025-05/473ea6c1d3a84de031141c2231b7a7cb.webp)

上层的图片表变化最多，要展开讲讲。图片表每行都是一张具体的插图，客户表格里的需求内容往场景列（scene）一贴，多维表自带的免费豆包模型就会把描述总结成10个字以内的画面标题。这个标题既为了自己方便查找，也用来拼接出图片文件名。

![卖AI图，从开单到金盆洗手：Notion图片表带辅助创作extra instruction字段的详细场景备注](https://cdn.victor42.work/posts/2025-05/b6bf0ac54f2ea21dc47cbb73168df424.webp)

然后，为每张插图选定所属项目（可以选好一行其他复制粘贴），就会有一列从项目表里读取该图片的风格，并把风格提示词作为前缀加到完整绘图提示词的开头。

![卖AI图，从开单到金盆洗手：Notion图片表AI自动生成的提示词输出结果与风格提示词列对比](https://cdn.victor42.work/posts/2025-05/7c6ba3b341f4281f8851f427c533a95e.webp)

如果画面里出现了主角，则在人物列选择人物。我准备了3个人物列，也就是说一个画面支持3个主角同时出现。人物列会从人设表里把外貌描述读取过来，作为完整绘图提示词的信息素材。

![卖AI图，从开单到金盆洗手：Notion图片表Finished视图的completed字段筛选条件面板设置](https://cdn.victor42.work/posts/2025-05/8fff47a4821a17760fe36f61bbe00326.webp)

我还加了一列人工指令，当对画面有明确而具体的要求时，就直接写在这里。比如要求时间是夜晚，环境是户外。这也会作为信息素材。

![卖AI图，从开单到金盆洗手：Notion图片表含retry重试ps修图fix修复inpaint局部重绘任务状态复选框](https://cdn.victor42.work/posts/2025-05/22d11320d3bdedae77b2f8ad9203be1b.webp)
...
![卖AI图，从开单到金盆洗手：Notion图片表Retry视图弹出以CSV格式下载当前视图数据对话框](https://cdn.victor42.work/posts/2025-05/274e00e94af16eae68ec02cdbe6dbab4.webp)
...
![卖AI图，从开单到金盆洗手：Notion图片表完整多视图标签栏含Grid生成重试修图修复局部完成标签](https://cdn.victor42.work/posts/2025-05/c741c58de2d7e77c366c19302eb82a0f.webp)
...
![卖AI图，从开单到金盆洗手：Notion图片表导出CSV数据时的下载设置弹窗界面](https://cdn.victor42.work/posts/2025-05/28ca2f09b169b2a7b9e15ef5c4f5e751.webp)
...
![卖AI图，从开单到金盆洗手：VSCode中自动生图和放大的两个Python脚本文件](https://cdn.victor42.work/posts/2025-05/694b43584e1e198df6c1ccb5e6101d76.webp)

这是指两个程序，1号和2号。它们覆盖了自动化流程里的中间一段，从绘图提示词到产出高清图。

![卖AI图，从开单到金盆洗手：包含图片ID、风格及AI最终提示词的CSV数据表格截图](https://cdn.victor42.work/posts/2025-05/2669bc1721b0a5db2ac68aad8a8548ec.webp)
...
![卖AI图，从开单到金盆洗手：RunComfy平台的API参考接口文档介绍页面](https://cdn.victor42.work/posts/2025-05/ab957480ff349869e11b97a2e54ea088.webp)
...
![卖AI图，从开单到金盆洗手：VSCode中封装了RunComfy工具函数的Python脚本文件](https://cdn.victor42.work/posts/2025-05/f3d224fd5e14e664d557f4cb1edf8b51.webp)
...
![卖AI图，从开单到金盆洗手：记录AI绘图脚本运行时长、机器类型和费用成本的运行日志表格](https://cdn.victor42.work/posts/2025-05/c46f347622627b3db3c345f09790da49.webp)
...
![卖AI图，从开单到金盆洗手：VSCode中自动调整图片分辨率的Python脚本文件](https://cdn.victor42.work/posts/2025-05/c4c8c52bb1afcb44239ccb918dbf2058.webp)

这就是3号程序，把处理分辨率和图片尺寸的环节自动化了。

![卖AI图，从开单到金盆洗手：Photoshop中设置图片尺寸10x10厘米及450分辨率的对话框截图](https://cdn.victor42.work/posts/2025-05/e4e2309950491e205d7248bc2b411eb4.webp)
...
![卖AI图，从开单到金盆洗手：儿童画插图中角色裤子表面呈现的不均匀水彩纹理细节](https://cdn.victor42.work/posts/2025-05/a737e078b94aa4628d54bb92866f57b1.webp)

*比如裤子上这种不均匀的明暗变化。*

至于扁平风格，客户想要的其实是一种很特殊的风格，并非那种纯色色块构成的商业矢量插画。细看参考图，扁平色块上有白色颗粒感的笔触，创造出一种彩色铅笔的质感。而模型生成图片，色块部分则完全是纯色。

![卖AI图，从开单到金盆洗手：插图角色衣服与裤子表面带有红色箭头指示的微妙蜡笔涂抹痕迹](https://cdn.victor42.work/posts/2025-05/6db5ffcec403296da17fe182ecd620e5.webp)
*微妙的涂抹痕迹。*
...
![卖AI图，从开单到金盆洗手：用于叠加的两种艺术肌理对比左侧为水彩纹路右侧为蜡笔笔触](https://cdn.victor42.work/posts/2025-05/5e5e34bfd741edd3e214b22e159c43e8.webp)
...
![卖AI图，从开单到金盆洗手：Photoshop动作面板中录制的CMYK格式TIFF水彩处理步骤列表](https://cdn.victor42.work/posts/2025-05/44365d71b3b51ad5992c4b473ef89b92.webp)
...
![卖AI图，从开单到金盆洗手：Photoshop批处理对话框中设置源文件夹与目标输出目录的界面](https://cdn.victor42.work/posts/2025-05/e77285da6ae2e3d9aa3d6f462d5203de.webp)
...
![卖AI图，从开单到金盆洗手：一台带有齿轮结构的卡通照片打印机正在打印儿童插图卡片](https://cdn.victor42.work/posts/2025-05/89852ef4042c193cd77916efb0cf70b6.webp)
...
![卖AI图，从开单到金盆洗手：微信聊天记录中插画师回复抱歉价格有点低退出的聊天气泡截图](https://cdn.victor42.work/posts/2025-05/bd059893485a3171e15896055c37db35.webp)
...
![卖AI图，从开单到金盆洗手：一名疲惫的男设计师夜间在电脑前使用数位板修改儿童插图](https://cdn.victor42.work/posts/2025-05/ab26869c9528a694c72f501cd1f58b4a.webp)
...
![卖AI图，从开单到金盆洗手：3D风格的写有修改意见并全部打勾确认的写字板插图](https://cdn.victor42.work/posts/2025-05/e17c077275c98414ca17a7963e7ad960.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的穿着国外风格警服并在十字路口指挥交通的交警插图](https://cdn.victor42.work/posts/2025-05/db5aa83baa17fb0a76780ca9fbcf9ee2.webp)
...
![卖AI图，从开单到金盆洗手：Liblib平台提示图片违反内容规则请检查提示词的屏蔽警告截图](https://cdn.victor42.work/posts/2025-05/75dcc6c3d624d2e3a9e4bac512cbec52.webp)

这是Liblib的限制，禁止生成一些可能有法律风险的内容。无论是提示词里带有“警察”，还是生成的图太像警服，都会触发屏蔽。当然，你也可以选择一些没有屏蔽的平台，不过Liblib它便宜啊，是没有好显卡时的绝佳选择。

![卖AI图，从开单到金盆洗手：AI生成的穿着普通蓝色短袖衬衫和深蓝色长裤指挥交通的交警插图](https://cdn.victor42.work/posts/2025-05/1e5a122d6b5b91b43baaa2b43876f9be.webp)

但如果去掉警察相关的词，画出来真的就是很普通的短袖蓝衬衫，不像警服了。写也不是，不写也不是。

![卖AI图，从开单到金盆洗手：豆包AI生成的具有中国特征交警警服样式与装备的交通指挥插图](https://cdn.victor42.work/posts/2025-05/2529da2758620d3dfeab11761351e3a8.webp)

既然Liblib上的Flux这么扭捏，不如试试别的工具。豆包的即梦模型没有这个限制，而且效果不错，大概样子就出来了。

![卖AI图，从开单到金盆洗手：AI生成的穿着中国交警制服但配戴白色非标准大檐帽的交通指挥插图](https://cdn.victor42.work/posts/2025-05/54ee3fc5a4cfd8501d552646c75284c9.webp)

白色交警帽难度更高，豆包也画不对，像高档酒店门口的停车引导员。白色交警帽样式有它鲜明特征，特征少了，相似度会直线下降。

![卖AI图，从开单到金盆洗手：用于图像参考对比的绿色军警帽与白色交通警警帽素材](https://cdn.victor42.work/posts/2025-05/c411868588a3d4ab82b96e0222b99569.webp)

可以找个角度大致吻合的交警帽P上去。注意，为了避免被屏蔽，先用PS把上面的警徽给擦掉，等图片不必经手AI了再加回来。这里能看到PS内容识别填充的威力，轻松就把警徽去掉了。

![卖AI图，从开单到金盆洗手：使用垫图功能后AI生成的戴有正确中国交警大檐帽的交通指挥插图](https://cdn.victor42.work/posts/2025-05/f74f6dd66e7b3d25c577c034a5702251.webp)

把帽子摆好位置，现在还是写实风格。

![卖AI图，从开单到金盆洗手：Photoshop滤镜库中对警帽素材应用木刻滤镜进行矢量化简化的操作界面](https://cdn.victor42.work/posts/2025-05/6864713301b8fc20d04e43464f406aef.webp)

给帽子加上木刻滤镜，减少颜色数量，风格一下就变扁平了。

![卖AI图，从开单到金盆洗手：最终合并并拼贴好正确警帽的交警在十字路口指挥交通插图](https://cdn.victor42.work/posts/2025-05/3cc0c42436d29bbbdc801419b5132866.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的包含十六格不同姿态少年跳绳及站立的人物设定稿](https://cdn.victor42.work/posts/2025-05/813b5f29f395b365d75a573510bbd525.webp)

这张插图又触及Flux的能力边界了。它跳绳的场面肯定见太少，画的都是小孩胡乱挥舞绳子，甚至能有绳子就已经不错了。本想大力出奇迹，一口气生成16张图，居然一张能用的都没有。

![卖AI图，从开单到金盆洗手：儿童跳绳插图中双脚站立且动作悬空不自然的少年原画](https://cdn.victor42.work/posts/2025-05/bf930d87fa1154fe17e4f2013413ac7e.webp)

不过没关系，只要动作对，跳绳可以画上去。这张最有改造潜力，PS胡乱画个跳绳，就有点像那么回事了。

![卖AI图，从开单到金盆洗手：ComfyUI中输入一侧腿部被擦除的少年插图并生成重绘单腿跳绳的对比](https://cdn.victor42.work/posts/2025-05/0bdd32c6089ae401973dd5a61ed22352.webp)

使用转绘工作流，降噪值设为0.7。大体保持原图内容，留给AI的发挥余地足够让它把跳绳画得更真实。

![卖AI图，从开单到金盆洗手：少年跳绳插图细节图中右手抓握手柄处手指粘连缺失拇指的畸形手部](https://cdn.victor42.work/posts/2025-05/81994b8ebc515c2335c38ca88af4cd52.webp)

这里展开讲讲手部的修复。可以看到小孩右手没有拇指，或者说拇指和食指连成一片了。虽然可以直接在这张图上局部重绘，但手持物体的情况，AI往往画不好，大量重试都不一定能成功。

![卖AI图，从开单到金盆洗手：少年跳绳插图细节图中经过放大局部重绘修复后的正常手部和手指](https://cdn.victor42.work/posts/2025-05/7f160a7d5e857e979e5e921a5f50e7c0.webp)
...
![卖AI图，从开单到金盆洗手：少年跳绳插图被划分为网格切片且右手所在切片被黄框圈出选中的示意图](https://cdn.victor42.work/posts/2025-05/d303746e3f41c2f46de76f0e0d4e843a.webp)
...
![卖AI图，从开单到金盆洗手：使用Python裁剪程序将手持跳绳手柄的局部手部区域裁剪提取出的图片切片](https://cdn.victor42.work/posts/2025-05/d9d292d343442ac6fc78f6f3b5e9a071.webp)

再对切片图用局部重绘，一次成功。降噪值可以看情况调整，原先的手问题很大，降噪值就要高。反过来，如果像本图情况，手的大部分姿势是对的，降噪值就要低，避免引入新问题。

![卖AI图，从开单到金盆洗手：少年跳绳插图中使用程序将修复好右手的切片贴回后的完整图片](https://cdn.victor42.work/posts/2025-05/2ffdc82e5708f25cae0968d52104a34b.webp)

再运行配套的粘贴程序，它根据裁剪时的行列序号，准确把切片贴回原图上。

不过这个人物的姿态还是不太自然，客户提过这样的意见，他们觉得人物站在地面不像是跳起来了。

![卖AI图，从开单到金盆洗手：Photoshop中使用套索工具选中少年脚部及小腿区域的选区状态](https://cdn.victor42.work/posts/2025-05/80984f51c5c32d29452c2b77dcc9cb7e.webp)

也行，这个用PS就能处理：操控变形。先用快速选择工具把整个小腿和脚都选中，复制到新图层里。

![卖AI图，从开单到金盆洗手：Photoshop中对少年腿部图层应用操控变形并添加固定销钉钉点的状态](https://cdn.victor42.work/posts/2025-05/98e84bc437e314249275cbf84aa844df.webp)

开启操控变形，关节处用很多钉子钉住了。

![卖AI图，从开单到金盆洗手：Photoshop中通过操控变形将脚部向后拉伸使小腿弯曲的调整过程](https://cdn.victor42.work/posts/2025-05/05505577b660903338c934e797ce976d.webp)

按住鞋子往后一拉，腿就弯过来了。

![卖AI图，从开单到金盆洗手：少年跳绳插图中使用操控变形弯曲腿部并擦除原图层后的最终效果图](https://cdn.victor42.work/posts/2025-05/51e37816517857e2a5e3de4aac977e63.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的带有笔直垂下如榕树气根般枝条的柳树设定对比草图](https://cdn.victor42.work/posts/2025-05/c967b3025d11e60d1271281e25386eb2.webp)

画出来这枝繁叶茂的样子，笔直垂下的枝条甚至有点像榕树的气生根。

![卖AI图，从开单到金盆洗手：关掉风格Lora后AI生成的写实照片风格但枝条依然笔直下垂的柳树](https://cdn.victor42.work/posts/2025-05/d30f4d7e5d46504b21a7d7c84489d6b7.webp)

我想看看是Flux不认识柳树，还是被我的风格Lora污染了，在这种风格下所有树都画成这样。于是关掉Lora，去掉风格提示词，让它生成写实照片，发现它原来真的不认识柳树。

![卖AI图，从开单到金盆洗手：AI生成的作为修改基础的带有非标准下垂枝条的雨中柳树插图](https://cdn.victor42.work/posts/2025-05/e2056a4798b13e462a1b5e9aba516a42.webp)

那就在这张基础上改吧。

![卖AI图，从开单到金盆洗手：使用AI改图功能擦除柳树后仅保留乌云下雨和河岸背景的插图](https://cdn.victor42.work/posts/2025-05/ddd14ff6641e1ee25127d9a1840b3de9.webp)

先用豆包对话改图把树去掉，留下背景。

![卖AI图，从开单到金盆洗手：从网络获取的黑白剪影风格且带有明显大风弯曲特征的柳树素材](https://cdn.victor42.work/posts/2025-05/d92d942175df1ade53b3e4d04be7051f.webp)

再想办法弄出一棵插画风格、枝条特征显著的柳树。直接网上找素材是最快捷的方法。

![卖AI图，从开单到金盆洗手：使用AI将黑白剪影柳树着色为绿色叶片和棕色树干的彩色插图素材](https://cdn.victor42.work/posts/2025-05/f996ddb5918e02a4147cb641585b69a6.webp)

豆包对话改图把柳树改成彩色的。

![卖AI图，从开单到金盆洗手：在Photoshop中粗糙拼贴组合后的彩色柳树与雨景背景图](https://cdn.victor42.work/posts/2025-05/ef9fd27e8d5ce4ab25be8f3e2cd5f236.webp)

用PS粗糙地拼起来。

![卖AI图，从开单到金盆洗手：采用低降噪值图生图对拼贴画面进行多次迭代转绘融合的对比图](https://cdn.victor42.work/posts/2025-05/0c045d3499a461388ba0da3b73e0580b.webp)

经过几轮低降噪值转绘（0.3），效果就比较自然了。

![卖AI图，从开单到金盆洗手：暴风雨中的柳树彩色插图最终成品修改后叶片颜色更加明亮](https://cdn.victor42.work/posts/2025-05/d940674731cde3d2882dd0d831919279.webp)
...
![卖AI图，从开单到金盆洗手：AI生成的结构混乱且人物动作不合逻辑的儿童打扫教室插图草稿](https://cdn.victor42.work/posts/2025-05/578d5efac9246d9c58ceb283d5c6ec0e.webp)

这个画面要体现一个小孩擦窗户，其他小孩在打扫别的地方。AI一遇到这种人物众多要求复杂的情况就漏洞百出。人物动作不合逻辑，课桌椅也缺胳膊少腿，没有一张能用的。

![卖AI图，从开单到金盆洗手：从网络获取的作为转绘模板的儿童打扫卫生手绘插图素材](https://cdn.victor42.work/posts/2025-05/ce465b01e62e61cdada1358b5a67c56a.webp)

这些问题一个个修，不如找一张真实照片或手工插画来转绘。至少里面人物和环境都是合理的，在转绘过程中可能引入少量问题，但也比凭空生成的容易修。

![卖AI图，从开单到金盆洗手：使用高降噪值转绘后符合绘图风格的儿童打扫教室插图草稿](https://cdn.victor42.work/posts/2025-05/f6c9dc079eace191a3f46fcb781a59ec.webp)

降噪值开到1，转绘完，风格就拗过来了。

![卖AI图，从开单到金盆洗手：ComfyUI中输入红色塑料水盆与遮罩区域以重绘替换旧木盆的工作流](https://cdn.victor42.work/posts/2025-05/7540b49eb356dfb07dc5a09ff20f38e9.webp)

盆的造型太古老了，换个现代的盆。不过盆太深了，手也缺了，可以之后再修。其他小问题用简单的修补方法都可以搞定。

这张图的问题比我给客户的图少，有个典型问题没有出现：抹布造型。

![卖AI图，从开单到金盆洗手：由于提示词使用了rag而被AI生成为一团乱糟糟拖把头状的紫抹布](https://cdn.victor42.work/posts/2025-05/2d389e03b7309c44d970a373bbb9289a.webp)

在给客户的图片中，有一版过程稿里的抹布长这样。提示词里用的单词是rag，确实是抹布。但这个英文单词也有破布的意思，Flux就把它画成这样乱糟糟一团，像个拖把头。

![卖AI图，从开单到金盆洗手：将提示词更改为cloth后局部重绘出的平整干净蓝色抹布](https://cdn.victor42.work/posts/2025-05/f20f4461d8bec868d37203ab6abdb97b.webp)
