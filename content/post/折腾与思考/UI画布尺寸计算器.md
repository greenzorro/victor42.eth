...
![UI画布尺寸计算器：不同屏幕使用距离下 PPI 除数分布的箱线图](https://cdn.victor42.work/posts/2025-06/15386d1877e20780e6c1b43dbf92ab10.webp)
...
最初是做了一个 [Excel版计算器](https://my.feishu.cn/wiki/XLl9w5iSkiWPDIkUhfac4DF6n5e?from=from_copylink)，为了验证我的计算方法是否正确。但使用不够直观友好，不适合作为正式产品。索性做成一个公开可访问的网页小工具吧！需求反正已经写这么详细了，用AI编程，不一次搞定都说不过去了。
...
![UI画布尺寸计算器网页显示输入参数和画布结果](https://cdn.victor42.work/posts/2025-06/Xnip2025-06-11_10-40-02.webp)
