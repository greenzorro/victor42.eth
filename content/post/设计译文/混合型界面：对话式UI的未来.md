...
![混合型界面：对话式UI的未来：Linux命令行界面，最初的对话式UI通过文字指令与电脑交互](https://cdn.victor42.work/posts/2017-01/01-05/1-vgMiTstFJG8nYmTSY0Od_g.png)
...
![混合型界面：对话式UI的未来：Xerox Star图形化用户界面，用文件夹按钮垃圾桶等视觉隐喻取代命令行](https://cdn.victor42.work/posts/2017-01/01-05/1-SubONWzdZQXlUmH96fKlHA.jpeg)
...
![混合型界面：对话式UI的未来：Trivia聊天室机器人，早期聊天室中支持多人测验的对话式应用](https://cdn.victor42.work/posts/2017-01/01-05/1-_hBjjP9PVqgI6sHs4gC-DQ.jpeg)

*Trivia聊天室机器人*

即时通讯应用在视觉上更自然，随时间推移也开始支持更丰富的媒体格式，例如表情、照片、视频和小程序，例如游戏或测验。第一批这类应用包括ICQ、AIM、MSN和Yahoo! messenger，在90年代末极度盛行。

![混合型界面：对话式UI的未来：MSN Messenger中的井字游戏小程序，90年代末即时通讯应用富媒体扩展](https://cdn.victor42.work/posts/2017-01/01-05/1-TpEf1IFD77jLrI-6GDu8uw.jpeg)
...
![混合型界面：对话式UI的未来：Assist短信聊天机器人界面，基于SMS的对话式服务体验近似命令行](https://cdn.victor42.work/posts/2017-01/01-05/1-DZksqy11nRFRRGwn9SwHxQ.png)
...
![混合型界面：对话式UI的未来：Slack中KhaledBot聊天机器人交互动画，展示API整合的对话式服务](https://cdn.victor42.work/posts/2017-01/01-05/1-LPOVLc7cAxrAjLNZaUPWTA.gif)
...
![混合型界面：对话式UI的未来：每条消息作为独立应用的混合界面动画，结合命令行快速输入与图形界面丰富体验](https://cdn.victor42.work/posts/2017-01/01-05/1-6tYG_b5PkO7QpY_PithljA.gif)

*每条信息都是独立应用*

每条消息都有成为一个独立应用的潜质。它可以显示文字、照片，或者在消息气泡的局限中展现更复杂的信息。有无限的可能，可以创造各种迷你应用，比如照片轮播、媒体播放器、迷你游戏、清单项、消息内支付等等。

![混合型界面：对话式UI的未来：富文本消息示例展示，音乐照片商店游戏测验快递酒店预订等迷你应用](https://cdn.victor42.work/posts/2017-01/01-05/1-v4dyDpzbolNjyexHGNiQsw.png)
...
![混合型界面：对话式UI的未来：Operator可操作消息卡片设计，用户可直接在消息内完成购买等复杂操作](https://cdn.victor42.work/posts/2017-01/01-05/1-hGEAZ8AfBrRWWLU-0llWFQ.png)
