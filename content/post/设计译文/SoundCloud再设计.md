...
![SoundCloud再设计：笔记本电脑屏幕展示的音乐网页概念设计图](https://cdn.victor42.work/posts/2014-12/12-12/1.jpg)
...
![SoundCloud再设计：网页顶栏中因宽度过长导致不美观的搜索框](https://cdn.victor42.work/posts/2014-12/12-12/1-5KosaVfu23UBKC5iYpjwXw.png)

*我通常会搜索艺人或歌曲名称*

**搜索栏太宽了。**最宽状态下，网站有1240像素宽，搜索栏输入框就有668像素。通常输入几个字后，自动补全功能就可以完成查询。

![SoundCloud再设计：网页底部排列拥挤且层级混乱的播放器控制条](https://cdn.victor42.work/posts/2014-12/12-12/1-cR1Ug-Twv0iwKoyaHvUxrQ.png)
...
![SoundCloud再设计：点击用户名弹出的缺少视觉指示的下拉菜单](https://cdn.victor42.work/posts/2014-12/12-12/1-DrkOUYfP9yd4bMXyLpKbxw.png)

**点击我的用户名会出现下拉菜单。**没有任何视觉指示告诉我这下面（也就是下箭头）有下拉菜单，这样展现很古怪。这网站我用了好几年，我的直觉仍然告诉我，它应该指向我的个人资料。我通常点这里去我的个人资料、喜欢和播放列表。

###解决方案概念

![SoundCloud再设计：原版导航栏与重新设计的播放器导航栏对比](https://cdn.victor42.work/posts/2014-12/12-12/1-HGY-yavhWdu9ZyavSMpLMw.png)
...
![SoundCloud再设计：原版社交音乐平台首页时间轴信息流排版图](https://cdn.victor42.work/posts/2014-12/12-12/1-qtFvyx7uOYG95_oH1JGKRQ.png)
...
![SoundCloud再设计：原版音频播放波形图上排布的微小留言者头像](https://cdn.victor42.work/posts/2014-12/12-12/1-HNuMRAYtmwy_jM6mqcJu2g.png)

*有认识的人评论了这首歌吗？*

![SoundCloud再设计：交互设计中用户返回信息流时的界面期望演示图](https://cdn.victor42.work/posts/2014-12/12-12/1-MvVz5KJdMZ8VH47m7FfR6g.gif)
...
![SoundCloud再设计：重新设计的卡片式歌曲信息流与固定侧边栏图](https://cdn.victor42.work/posts/2014-12/12-12/1-2adhccrEz9bZ8-42QkFmJQ.png)
...
![SoundCloud再设计：音轨卡片鼠标悬停状态与发布时间气泡细节图](https://cdn.victor42.work/posts/2014-12/12-12/1-lxqylLZXbsBEAX1vEaCVWw.png)
...
![SoundCloud再设计：概念设计侧边栏中展示当前歌曲艺人简介卡片](https://cdn.victor42.work/posts/2014-12/12-12/1-UOwiG7qeyTa9Z4ckObqhQw.png)
...
![SoundCloud再设计：原版站外分享与站内私信功能的界面对比图](https://cdn.victor42.work/posts/2014-12/12-12/1-G_whpCAK1fr3P9JSDnC8Aw.png)
...
![SoundCloud再设计：重新设计后优先推荐站内私信的分享弹窗](https://cdn.victor42.work/posts/2014-12/12-12/1-6zp1QLp8RWt1OKtCVmPmrA.png)
...
![SoundCloud再设计：重新设计的消息列表与对话气泡界面效果图](https://cdn.victor42.work/posts/2014-12/12-12/1-geI0fEXABhJVJtW7mWbBiQ.png)
...
![SoundCloud再设计：原版设计中账号动态与歌曲动态的通知样式](https://cdn.victor42.work/posts/2014-12/12-12/1-UaUD2dyHu_CfyS5y3o7QmA.png)
...
![SoundCloud再设计：原版设计中多个错误弹窗层叠遮挡下拉菜单](https://cdn.victor42.work/posts/2014-12/12-12/1-DTCHs-qAdnfzeMlwmjnEuA.png)
...
![SoundCloud再设计：重新设计后可滚动的滑出式系统通知面板](https://cdn.victor42.work/posts/2014-12/12-12/1-ue49FejWYcL6toi7koQobA.png)
...
![SoundCloud再设计：重新设计后扁平且小巧的页面浮动通知弹窗](https://cdn.victor42.work/posts/2014-12/12-12/1-g0-5ThbaCwelMPgVXQzR0A.png)
