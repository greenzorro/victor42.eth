...
tags: ["设计", "翻译", "设计师", "数据可视化", "UI", "教程"]
url: /post/3516
---

**[国外设计第143期]**

![彩色网格数据表格设计示意图，用不同色块区分单元格数据类型与层级关系](https://cdn.victor42.work/posts/2016-08/08-05/1-WtQpQLwaycWzGw-6rMDc2Q.png)
...
![美国协调关税表HTS页面截图，展示密集的商品分类编码与税率数据表格](https://cdn.victor42.work/posts/2016-08/08-05/1-NoYxEosGh6slPJUUPE1buw.png)
...
![旧体数字Oldstyle与等高数字Lining字体对比，展示数字高度与基线差异](https://cdn.victor42.work/posts/2016-08/08-05/1-xWe8Z0-KdRwoncgUtIWG7g.png)
...
![比例数字Proportional与表格数字Tabular宽度对比，展示等宽对齐效果差异](https://cdn.victor42.work/posts/2016-08/08-05/1-Xj1N2kM1uKC58kRYGxehag.png)
...
![维基百科美国各州历年人口统计表，数字右对齐文字左对齐的标准表格布局](https://cdn.victor42.work/posts/2016-08/08-05/1-ReTh9L-cl-QStJVAUVqejA.png)
...
![NOAA密西西比河洪水水位预报表格，含位置、变化量与多日预测数据的简洁设计](https://cdn.victor42.work/posts/2016-08/08-05/1-na9P5f323Pi8sI-kpvLs9w.png)
...
![2016年美国棒球联盟击球统计数据表，多列密集数值展示极简分隔线设计](https://cdn.victor42.work/posts/2016-08/08-05/1-71B5i6rZMMsryN0pDwuXzw.png)
