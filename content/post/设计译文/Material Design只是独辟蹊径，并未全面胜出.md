...
tags: ["设计", "翻译", "设计师", "Material Design", "UI", "趋势"]
url: /post/3453
---

**[国外设计第97期]**

![安卓系统质感设计规范的官方主视觉插画](https://cdn.victor42.work/posts/2015-08/08-02/1-IgmrVCbleu-evmmRd666tg.jpeg)
...
![苹果与安卓界面关于深度与模糊的对比示意图](https://cdn.victor42.work/posts/2015-08/08-02/1-VIkd5NsktZXoejQhQ5zLww.png)
...
![苹果具有皮革与纸张纹理的拟物化日历界面](https://cdn.victor42.work/posts/2015-08/08-02/1-pZ3K06ZJoFIa3bsy8cDxwQ.png)

没有人再用这样的日历了。

![多彩半透明毛玻璃效果的苹果控制中心界面](https://cdn.victor42.work/posts/2015-08/08-02/1-jQ_Ua6XKAB3VhaswYlWJPA.png)

这两种设计语言都有各自的弱点。

例如，多层模糊相互叠加，有种割裂感。而且，有点太鲜艳了。

![圆形手表屏幕中卡片信息展示的界面示意图](https://cdn.victor42.work/posts/2015-08/08-02/1-056C3gBMDvzbGNdvUK1i0Q.png)

卡片的概念在圆形屏幕上看起来截然不同。卡片占据了整个宽度。文字的对齐方式感觉不协调，因为有很多不必要的留白。在圆形屏幕上，列表也难以使用，因为边角处隐藏了重要内容。

![专为圆形智能手表设计的多种精美表盘界面](https://cdn.victor42.work/posts/2015-08/08-02/1-aaQlu1sRK8ODngXiLz6hJw.jpeg)
...
![质感设计在网页端多设备上的响应式布局效果](https://cdn.victor42.work/posts/2015-08/08-02/1-QnQdq8ss2wbDCQJO108bVg.jpeg)

色彩、导航和行动召唤有强烈的聚焦作用。（这就是新的[Material Design Lite](http://www.getmdl.io)，为网页而生）

![苹果音乐设计在苹果全平台设备上的运行效果图](https://cdn.victor42.work/posts/2015-08/08-02/1-smW9Rz1JMernVpbr1p2Mpg.png)

相反在iOS中，关注点更多在内容上。界面的颜色更加中性、符合情境（它们会根据内容变化）。鲜明的色彩尽量少使用，通常都用于操作项。

![苹果与谷歌音乐网页设计风格对比示意图](https://cdn.victor42.work/posts/2015-08/08-02/1-IBrjUJRaLZwdMop5Dfr_pw.png)
...
![苹果手机版官网中使用汉堡菜单按钮的界面](https://cdn.victor42.work/posts/2015-08/08-02/1-8i7QwVzou7rZ2gGzfxtB7w.jpeg)
...
![谷歌收件箱手机应用使用汉堡菜单的列表界面](https://cdn.victor42.work/posts/2015-08/08-02/1-22mkZEyfXxrgDtZGaiIspw.png)
...
![三种主流扁平化设计风格的配色调色板对比图](https://cdn.victor42.work/posts/2015-08/08-02/1-vcFohzMITdzC727iEA-0aA.png)
...
![质感设计指南网页中大面积高饱和度页头展示](https://cdn.victor42.work/posts/2015-08/08-02/1--S1FOw02f-sY3mkx49vFVQ.png)
...
![质感设计规范网页卡片布局与排版细节图](https://cdn.victor42.work/posts/2015-08/08-02/1-k13le7SswwLnXec3XDZZBg.jpeg)
...
![苹果智能手表外观与屏幕界面的渲染图](https://cdn.victor42.work/posts/2015-08/08-02/1-EgcBgdCWEsPnvBl5AYmySg.png)

## Material Design定义更清晰

从材质如何操作和选用，到色彩如何结合，一切都在指南中有详细解释。

![质感设计中关于不同元素层级高度的规范图](https://cdn.victor42.work/posts/2015-08/08-02/1-0Z0sCyVy8GGfXjrZc5p-uQ.png)

每种设计元素应该如何选用，来创造统一的构造和投影。

![质感设计指南中色彩搭配正确与错误的对比图](https://cdn.victor42.work/posts/2015-08/08-02/1-i7EdIpyfwGdocgRpl1wnhQ.png)

有一套特定的配色方案和颜色的组合方式。

![谷歌质感设计官方提供的通用系统图标集](https://cdn.victor42.work/posts/2015-08/08-02/1-vJFuQrjj_FmCTr0F8I16mw.png)
...
![质感设计指南中关于红色与粉色调色板的展示](https://cdn.victor42.work/posts/2015-08/08-02/1-g19JfEXzo43tt535BQbYOw.png)
...
![质感设计中用于引导用户操作的过渡动效图](https://cdn.victor42.work/posts/2015-08/08-02/1-wMRs1E7yCnCSyuWo-lFG4Q.gif)
