...
![9种状态的设计：Framer应用初始状态设计，组件存在但尚未激活的空白界面](https://cdn.victor42.work/posts/2015-11/11-08/1-LNyqFzjiRNkqw186I2_YtQ.png)
...
![9种状态的设计：Facebook加载状态设计，用骨架屏假文章替代传统转圈加载动画](https://cdn.victor42.work/posts/2015-11/11-08/1-TpIehvczESpOJD7yQ3HF2g.gif)
...
![9种状态的设计：空状态设计示例，用引导性插画鼓励用户采取首次行动](https://cdn.victor42.work/posts/2015-11/11-08/1-IoVJzoP3v9_16IdpK9ww3g.png)
...
![9种状态的设计：单一项目状态设计，列表中仅有一项数据时的界面展示](https://cdn.victor42.work/posts/2015-11/11-08/1-fnfAL-lYn5V4ulHM2f3vWg.png)
...
![9种状态的设计：正常数据状态设计，UENO团队设计的舒适仪表盘展示适量数据](https://cdn.victor42.work/posts/2015-11/11-08/1-js-IckIHrUTT5KtZtiENSQ.png)
...
![9种状态的设计：数据过多状态设计，Pete Orme的翻页设计处理大量结果的分页展示](https://cdn.victor42.work/posts/2015-11/11-08/1-dp8v6F66fu5tfa4Dq_c31Q.png)
...
![9种状态的设计：错误状态设计，dunked.com的错误提示界面清晰告知用户问题所在](https://cdn.victor42.work/posts/2015-11/11-08/1-sk90HfKPbvisYcFsYjMm0A.png)
...
![9种状态的设计：正确状态设计，Ionut Bondoc的操作成功反馈界面](https://cdn.victor42.work/posts/2015-11/11-08/1-D8fkoQeLLFx1TNt5lBS0GA.png)
...
![9种状态的设计：完成状态设计动画，Igor Chebotarev的积极反馈动效展示任务完成](https://cdn.victor42.work/posts/2015-11/11-08/1-r6NdBjvStCqOWe4orT7bNQ.gif)
