...
tags: ["设计", "翻译", "设计师", "开发", "教程"]
url: /post/3403
---

**[国外设计第63期]**

![MacBook Pro屏幕上显示着代码编辑器与iOS模拟器并排的开发环境](https://cdn.victor42.work/posts/2014-11/11-19/1-S7qC-yi38y8hXJ4xUeUbHw.jpeg)
...
![Sketch设计工具与Xcode Storyboards界面对比，展示两者相似的三栏布局结构](https://cdn.victor42.work/posts/2014-11/11-19/1-Ga4fFZJOyccszV0Tots8rg.png)
...
![Swift Playground实时预览界面，左侧代码右侧即时显示图形绘制结果](https://cdn.victor42.work/posts/2014-11/11-19/1-JkYwzoQv0BcEFHAU5Q6rWg.png)
...
![Storyboard拖放式UI界面构建工具，展示可视化布局与多设备预览功能](https://cdn.victor42.work/posts/2014-11/11-19/1-aetFez9wiXKf8n5tTWmK7A.png)
...
![设计稿中的UI界面过渡动画效果展示，体现设计师对动效的关注](https://cdn.victor42.work/posts/2014-11/11-19/1-pyLbZ1e1eGDlcrnCZ6p7Jg.png)

和我聊过的很多开发者几乎没接触过动画。要求开发者实现你设计的动画，就像要求设计师写开发文档一样。他们没有受过那方面的系统训练。像Pixate、Framer和Form就是理想选择，因为它们专注于动画，而且它们提供的结果能够被开发者作为代码复制。

![Pixate或Framer原型工具生成的动画效果可导出为开发者可用的代码](https://cdn.victor42.work/posts/2014-11/11-19/1-shgVY0XT1lcSK7ZFavezEA.png)
