...
![典型企业后台界面设计，大数字与图表组合展示复杂数据分析](https://cdn.victor42.work/posts/2017-02/02-07/1-NuiuEnvRrYPfPQKhL3e5RQ.png)

有一些巨大的数字（人们都喜欢大数字，对吧？），有几张图表，可能还有表格。理论上，这些元素给用户讲了一个清晰明了的故事，让他们采取进一步措施。但是，现实情况则未必如此。

多数人眼中，这些典型的企业后台界面就像这样：

![连点成图谜题示意，散乱黑点中隐藏画面用户难以自行发现规律](https://cdn.victor42.work/posts/2017-02/02-07/1-4G0I_NhON8Llx5Y8krbJZg.png)
...
![Qubit客户体验管理平台后台界面，重要数据指标难以被用户理解](https://cdn.victor42.work/posts/2017-02/02-07/1-rrL9pEJR9OTdkg8OkW95lg.png)
...
![网站社交认同数字展示动画，单纯人数统计难以影响用户购买决策](https://cdn.victor42.work/posts/2017-02/02-07/1-7hdin4YIVbpIQvIxKkUjPw.gif)
...
![A/B测试后台界面改版，清晰展示新体验优于从前的数据证据](https://cdn.victor42.work/posts/2017-02/02-07/1-PQmrpQghLmmSIDKuFgh6xQ.png)
...
![后台信息拆分重组的视觉设计尝试，新布局仍未解决用户理解难题](https://cdn.victor42.work/posts/2017-02/02-07/1-JVCPpcAY1yJJ-v2Xw18Ndw.png)
...
![用自然语言描述数据的后台设计，帮助用户理解指标含义免去猜测](https://cdn.victor42.work/posts/2017-02/02-07/1-E2diwN_Z2mS3cOl9qwU05Q.png)

这样我们才能帮用户把一切联系起来，免去猜测，让他们掌握所需的信息。

![企业后台数据指标关联展示设计，将分散数据点连接成完整故事](https://cdn.victor42.work/posts/2017-02/02-07/1-ajrR4VN7SMgP8_im3_zyCg.png)

如果需要，资深用户仍然能看到每个指标的详细信息：

![资深用户查看指标详细信息的展开界面，保持科学严谨的同时提供深度数据](https://cdn.victor42.work/posts/2017-02/02-07/1-BxKOcfj6ri6hy0as3hWEGQ.png)
...
![连点成图谜题答案揭晓，散乱黑点连接后呈现出完整隐藏画面](https://cdn.victor42.work/posts/2017-02/02-07/1-cSbgCSd71Ma0PFB5wnrkLA.png)
