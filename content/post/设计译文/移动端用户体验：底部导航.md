...
![智能手机界面中展示的扁平化底部导航栏](https://cdn.victor42.work/posts/2016-10/10-27/1-KZ7WJkL39AiWnM9Gk8cAlQ.jpeg)
...
![智能手机单手持握时大拇指触摸热力分布图](https://cdn.victor42.work/posts/2016-10/10-27/0-LGs-zf1C4Ht4svsF.png)
...
![社交软件界面中包含五个图标的底部导航栏](https://cdn.victor42.work/posts/2016-10/10-27/1-d55w8RiaAGkt2UvdpK5OvQ.png)
...
![底部导航栏少于三个目的地时的设计对比图](https://cdn.victor42.work/posts/2016-10/10-27/1-B9m8qRpUEZYD4F_0SA6kLw.jpeg)

底部导航*避免使用5个以上*，因为点击目标相互会过于接近。在标签栏放置过多的项目，让人们难以点中他们的目标。每多展示一个标签，app的复杂性就增加一分。

![包含五个以上目的地的底部导航栏设计图](https://cdn.victor42.work/posts/2016-10/10-27/1-6Is4BT1OKgWVRkrSdBQcTA.jpeg)
...
![移动应用中横向滚动底部导航栏的错误示例](https://cdn.victor42.work/posts/2016-10/10-27/1-bkHSqELDmKmeOLexUOOFVw.gif)
...
![缺少文字标签导致功能含义难辨的底部导航栏](https://cdn.victor42.work/posts/2016-10/10-27/1-AjlvWHiXjxwuHbdCSA_DVQ.png)
...
![底部导航栏使用单一主色提亮选中的对比图](https://cdn.victor42.work/posts/2016-10/10-27/1-Et8v3bA25LSsSc2l61OsvA.jpeg)

*左图：不同颜色的图标让app看起来像是圣诞树。右图：应该只用主色。*

遵循一条简单的法则——用app的主色来提亮当前的底部导航项（包括图标和文字标签）。

![社交软件中使用主色提亮选中标签的菜单栏](https://cdn.victor42.work/posts/2016-10/10-27/1-YT7qQhVp2JB9z0iGtd1B6g.png)

*iOS版Twitter的底部菜单栏。Messages是当前选中项。*

如果底部导航栏有背景色，就要用黑白的图标和文字标签。

![彩色背景底部导航中使用黑白图形的对比图](https://cdn.victor42.work/posts/2016-10/10-27/1-8eEkSGJLqQeoquAzNJ0kiQ.jpeg)
...
![导航栏中换行截断与缩小文字标签的错误示例](https://cdn.victor42.work/posts/2016-10/10-27/1-cEJqW6n9A7eWVf7HfyeZWw.jpeg)
...
![安卓设计规范中关于底部导航栏尺寸的标注图](https://cdn.victor42.work/posts/2016-10/10-27/1-Wztcb149mWIooBzkeg4Kow.png)
...
![应用商店导航栏中使用小红点气泡提示更新](https://cdn.victor42.work/posts/2016-10/10-27/1-B7gU36PRo7TyamxXkFtXnA.png)
...
![点击底部导航栏切换界面的交互过渡效果图](https://cdn.victor42.work/posts/2016-10/10-27/1-SiIwMULz6BIH_QNrkSQo5w.gif)

不要用标签栏提供控制项，用来操作当前界面或app模式中的元素。如果需要提供操作项，请改用工具栏。

![苹果系统设计中用于操作当前页面的工具栏](https://cdn.victor42.work/posts/2016-10/10-27/1-HTJII_nZOV_9TzbpvIm0Gg.png)
...
![移动端应用中展示无数据提示的空状态界面](https://cdn.victor42.work/posts/2016-10/10-27/1-djnf36jd9NnOyKHktnQP9A.png)
...
![页面向下滑动时底部导航栏动态隐藏交互图](https://cdn.victor42.work/posts/2016-10/10-27/1-oN4qwzfoyuIDqPOmSrDQbg.gif)
...
![激活与未激活界面切换时的叠加渐隐动画图](https://cdn.victor42.work/posts/2016-10/10-27/1-UB9nYamoOKsGwhxX5YSQsA.gif)
