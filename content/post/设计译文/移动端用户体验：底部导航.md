...
tags: ["设计", "翻译", "设计师", "移动端", "UX", "导航", "教程"]
url: /post/3527
---

**[国外设计第151期]**

![iPhone白色机身斜放展示财务管理应用界面，底部绿色导航栏含Revenue、Transactions、Overview、Settings四个图标标签](https://cdn.victor42.work/posts/2016-10/10-27/1-KZ7WJkL39AiWnM9Gk8cAlQ.jpeg)
...
![两只手分别以左右手持握智能手机的线稿插图，屏幕用绿色黄色红色标注拇指可触及的舒适区域范围](https://cdn.victor42.work/posts/2016-10/10-27/0-LGs-zf1C4Ht4svsF.png)
...
![Facebook iOS版底部标签栏特写，含News Feed蓝色选中状态及Requests、Messages、Notifications、More四个灰色图标](https://cdn.victor42.work/posts/2016-10/10-27/1-d55w8RiaAGkt2UvdpK5OvQ.png)
...
![Android底部导航栏对比图，左侧红框标注两个标签项Recents和Favorites，右侧绿框标注三个标签项含Nearby](https://cdn.victor42.work/posts/2016-10/10-27/1-B9m8qRpUEZYD4F_0SA6kLw.jpeg)

底部导航*避免使用5个以上*，因为点击目标相互会过于接近。在标签栏放置过多的项目，让人们难以点中他们的目标。每多展示一个标签，app的复杂性就增加一分。

![Android底部导航栏含六个图标项，从左到右依次为视频、音乐、Books书本、日历、游戏手柄和公文包图标](https://cdn.victor42.work/posts/2016-10/10-27/1-6Is4BT1OKgWVRkrSdBQcTA.jpeg)
...
![Rookie Cam应用动态演示，底部工具栏图标横向滚动展示裁剪、旋转、亮度等编辑功能，部分图标被遮挡](https://cdn.victor42.work/posts/2016-10/10-27/1-bkHSqELDmKmeOLexUOOFVw.gif)
...
![黑色背景上四个白色线框图标，从左到右依次为圆形、六边形、放大镜和三点省略号，无文字标签难以辨识功能](https://cdn.victor42.work/posts/2016-10/10-27/1-AjlvWHiXjxwuHbdCSA_DVQ.png)
...
![Android底部导航栏颜色对比，左侧红框内图标和文字使用蓝绿红多种颜色，右侧绿框内统一使用深青色主色调](https://cdn.victor42.work/posts/2016-10/10-27/1-Et8v3bA25LSsSc2l61OsvA.jpeg)

*左图：不同颜色的图标让app看起来像是圣诞树。右图：应该只用主色。*

遵循一条简单的法则——用app的主色来提亮当前的底部导航项（包括图标和文字标签）。

![Twitter iOS版底部导航栏，Timelines、Notifications为灰色，Messages为蓝色选中状态带信封图标，Me为人物剪影](https://cdn.victor42.work/posts/2016-10/10-27/1-YT7qQhVp2JB9z0iGtd1B6g.png)

*iOS版Twitter的底部菜单栏。Messages是当前选中项。*

如果底部导航栏有背景色，就要用黑白的图标和文字标签。

![Android深青色背景底部导航栏对比，左侧红框内图标使用青橙白多色，右侧绿框内统一使用白色单色图标和文字](https://cdn.victor42.work/posts/2016-10/10-27/1-8eEkSGJLqQeoquAzNJ0kiQ.jpeg)
...
![三组Android底部导航栏对比，分别展示Crowd Favorites文字换行、Crowd Favori截断省略和Crowd Favorites Meals字体缩小的问题](https://cdn.victor42.work/posts/2016-10/10-27/1-cEJqW6n9A7eWVf7HfyeZWw.jpeg)
...
![Material Design底部导航栏尺寸规范图，粉色标注线显示导航栏高度56dp、图标24dp、文字标签间距等具体数值](https://cdn.victor42.work/posts/2016-10/10-27/1-Wztcb149mWIooBzkeg4Kow.png)
...
![App Store底部导航栏含Featured、Top Charts、Near Me、Search和Updates五个标签，Updates图标右上角有红色数字2角标](https://cdn.victor42.work/posts/2016-10/10-27/1-B7gU36PRo7TyamxXkFtXnA.png)
...
![iOS照片应用动态演示，底部导航栏在Photos蓝色选中、Shared和Albums三个标签间切换，界面内容随之淡入淡出过渡](https://cdn.victor42.work/posts/2016-10/10-27/1-SiIwMULz6BIH_QNrkSQo5w.gif)

不要用标签栏提供控制项，用来操作当前界面或app模式中的元素。如果需要提供操作项，请改用工具栏。

![iOS顶部工具栏含Inbox(13)标题、上下箭头、旗帜、文件夹、垃圾桶、回复和编辑七个蓝色图标按钮](https://cdn.victor42.work/posts/2016-10/10-27/1-HTJII_nZOV_9TzbpvIm0Gg.png)
...
![Dropbox离线文件空状态界面，顶部标题Offline Files，中间插画展示文件盒被鸟叼走，底部导航栏Offline蓝色选中](https://cdn.victor42.work/posts/2016-10/10-27/1-djnf36jd9NnOyKHktnQP9A.png)
...
![Android应用动态演示，内容列表向上滚动时底部导航栏逐渐隐藏，向下滚动回顶部时导航栏重新滑入显示](https://cdn.victor42.work/posts/2016-10/10-27/1-oN4qwzfoyuIDqPOmSrDQbg.gif)
...
![Material Design动态演示，底部导航栏Movies&TV选中状态下，内容卡片从Countryside Vet切换到Town of Golds的叠加渐隐过渡效果](https://cdn.victor42.work/posts/2016-10/10-27/1-UB9nYamoOKsGwhxX5YSQsA.gif)
