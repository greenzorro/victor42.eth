...
tags: ["设计", "翻译", "设计师", "数据可视化", "配色", "教程"]
url: /post/3472
---

**[国外设计第112期]**

![数据可视化配色方案示意图，展示从浅绿到深蓝的多组渐变柱状图](https://cdn.victor42.work/posts/2015-11/11-27/1-wG4NGJ_Q3qKm6lyznGMrxQ.jpeg)
...
![Flat UI 配色方案色板，展示绿蓝紫灰黄橙红白灰等15种鲜艳色彩的完整模式](https://cdn.victor42.work/posts/2015-11/11-27/1-KvDEGIpfwdJtUFwB5acYEA.png)

![Flat UI 配色方案在红色盲模式下的色板，颜色变为黄绿蓝灰等低对比度色调](https://cdn.victor42.work/posts/2015-11/11-27/1-agD5sQvrMt6GqRmIg6zKQA.png)

![Flat UI 配色方案在灰度模式下的色板，所有颜色变为不同深浅的灰色，辨识度极低](https://cdn.victor42.work/posts/2015-11/11-27/1-PyjFTbCq6JBTx1oymoXeEw.png)
...
![Color Hunt 社区12组四色配色方案，每组由四种不同颜色的矩形色块组成](https://cdn.victor42.work/posts/2015-11/11-27/1-ypvRymT0ECQ3pYwtqlfHZw.png)
...
![Color Hunt 社区12组渐变色板，每组颜色明度差异过小难以区分](https://cdn.victor42.work/posts/2015-11/11-27/1-S85p-zgE9OM9xLTLEKhbng.png)

我们试着选[第一组](http://colorhunt.co/#00a38879bd8fbeeb9fffff9d)，把它扩展为10级色彩：

![绿色渐变强行扩展为10级色板，4级和10级数据系列中相邻绿色几乎无法区分](https://cdn.victor42.work/posts/2015-11/11-27/1-623V9z7Xzs1Q3Uyf0qoq-A.png)
...
![Google Material Design 浅蓝色系完整色板，从50到900共10级明度渐变，附十六进制色值](https://cdn.victor42.work/posts/2015-11/11-27/1-hGvw1suMqgupk8EgD068aA.png)

![Google Material Design 浅蓝色系在红色盲模式下的色板，颜色变为蓝紫色调渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-HnC6oy_l_8t4bHxg1mMyhw.png)

![Google Material Design 浅蓝色系在灰度模式下的色板，从浅灰到深灰的10级明度渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-Op_34KD5WNhPdqxZs0TsVQ.png)

Google Material配色中的浅蓝色的完整色彩、红色盲模式与灰度模式。

但是，有一组明度跨度大的配色还不够。配色越多样，用户越容易将数据与图像联系起来。如果能善加利用色调的变化，就能使非色盲用户更加轻松。

![明度与色调双轴变化示意图，四个象限用笑脸表情展示色盲者和正常人的辨识差异](https://cdn.victor42.work/posts/2015-11/11-27/1-wgC_dBB1C2w3G6jaSFpZPQ.png)
...
![自然渐变与非自然渐变对比，浅黄到深紫渐变自然，浅紫到深黄渐变不自然](https://cdn.victor42.work/posts/2015-11/11-27/1-lL_koW3jH7nYf6_ZbFx3WA.png)

这是由于我们已经习惯于那些长期存在于自然界中的渐变。在华丽的日落中，我们就能看到明黄色向深紫色的渐变，但却没有哪里能看到淡紫色向深黄色的过渡。

![湖面日落景色，天空从橙黄渐变到粉红再到深紫，水面倒映着绚丽的晚霞](https://cdn.victor42.work/posts/2015-11/11-27/1-oIa-7FvHZYgGxPp0ytfY6w.jpeg)

![密苏里圆形泉水俯拍，周围绿叶环绕，泉水从浅绿渐变到深蓝色](https://cdn.victor42.work/posts/2015-11/11-27/1-PPPHMucunVmHYzFJBJW45Q.jpeg)

![海滩日落景色，天空从橙红渐变到紫色，栈桥剪影和两人在浅滩漫步的倒影](https://cdn.victor42.work/posts/2015-11/11-27/1-Jhvmh70U7q8P-_MajshKew.jpeg)
...
![密苏里圆形泉水中浅绿向藏蓝的自然渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-NUUVVX2MpC4Y1_nP8CHjWA.jpeg)

![秋季林荫道，两侧树木叶子从金黄渐变到橙红，地上铺满落叶，中间有绿色长椅](https://cdn.victor42.work/posts/2015-11/11-27/1-W5vjfZydrhjBbKQ4R9tl3A.jpeg)

![黄石公园温泉梯田，从白色钙华到橙黄再到棕红色的自然色彩渐变，蒸汽缭绕](https://cdn.victor42.work/posts/2015-11/11-27/1-_dsL23-byBssnWm7aFAKdg.jpeg)
...
![Photoshop CC 2015 中调整渐变叠加的截图，顶部灰度渐变条配青色辅助线，下方为多组彩色椭圆色值测试](https://cdn.victor42.work/posts/2015-11/11-27/1-wgvwormxteQ6jdT4De63Hg.png)
...
![冷色系渐变色板，从浅黄绿到深蓝黑，展示1到12级颜色数量对应的色块分布](https://cdn.victor42.work/posts/2015-11/11-27/1-B29h3NSglI42HGhWZA-5Mg.png)

![暖色系渐变色板，从浅黄到深棕黑，展示1到12级颜色数量对应的色块分布](https://cdn.victor42.work/posts/2015-11/11-27/1--Vgr9hPpUU3PYtg_B4rd2g.png)

![霓虹色系渐变色板，从浅粉到深紫黑，展示1到12级颜色数量对应的色块分布](https://cdn.victor42.work/posts/2015-11/11-27/1-pH2QoOf47OqwtG9suWaRJw.png)

冷色、暖色和霓虹色。

## 配色的实际运用

![各国兴奋剂违规次数柱状图，用蓝绿色系区分水上、田径、健美等不同运动项目](https://cdn.victor42.work/posts/2015-11/11-27/1.png)

![全球2型糖尿病死亡率热力地图，用黄到棕的渐变色表示各国死亡率高低](https://cdn.victor42.work/posts/2015-11/11-27/2.png)

![詹妮弗·劳伦斯参演电影类型柱状图，用粉紫渐变区分剧情、科幻、动作等类型](https://cdn.victor42.work/posts/2015-11/11-27/3.png)
