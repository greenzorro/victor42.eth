...
![为可视化数据寻找适合的配色：优秀数据可视化配色方案设计的指南图示](https://cdn.victor42.work/posts/2015-11/11-27/1-wG4NGJ_Q3qKm6lyznGMrxQ.jpeg)
...
![为可视化数据寻找适合的配色：扁平化用户界面设计配色方案色板展示](https://cdn.victor42.work/posts/2015-11/11-27/1-KvDEGIpfwdJtUFwB5acYEA.png)

![为可视化数据寻找适合的配色：扁平化界面配色在红色盲模式下的色板](https://cdn.victor42.work/posts/2015-11/11-27/1-agD5sQvrMt6GqRmIg6zKQA.png)

![为可视化数据寻找适合的配色：扁平化界面配色在灰度模式下的色板图](https://cdn.victor42.work/posts/2015-11/11-27/1-PyjFTbCq6JBTx1oymoXeEw.png)
...
![为可视化数据寻找适合的配色：色彩社区中不够灵活且无法扩展的色板](https://cdn.victor42.work/posts/2015-11/11-27/1-ypvRymT0ECQ3pYwtqlfHZw.png)
...
![为可视化数据寻找适合的配色：明度差异过小导致难以区分的配色色板](https://cdn.victor42.work/posts/2015-11/11-27/1-S85p-zgE9OM9xLTLEKhbng.png)

我们试着选[第一组](http://colorhunt.co/#00a38879bd8fbeeb9fffff9d)，把它扩展为10级色彩：

![为可视化数据寻找适合的配色：强行扩展十级色彩导致绿色相邻难区分](https://cdn.victor42.work/posts/2015-11/11-27/1-623V9z7Xzs1Q3Uyf0qoq-A.png)
...
![为可视化数据寻找适合的配色：谷歌材料设计浅蓝色单色系完整色板图](https://cdn.victor42.work/posts/2015-11/11-27/1-hGvw1suMqgupk8EgD068aA.png)

![为可视化数据寻找适合的配色：谷歌材料设计浅蓝色系在红色盲下的表现](https://cdn.victor42.work/posts/2015-11/11-27/1-HnC6oy_l_8t4bHxg1mMyhw.png)

![为可视化数据寻找适合的配色：谷歌材料设计浅蓝色系在灰度下的表现图](https://cdn.victor42.work/posts/2015-11/11-27/1-Op_34KD5WNhPdqxZs0TsVQ.png)

Google Material配色中的浅蓝色的完整色彩、红色盲模式与灰度模式。

但是，有一组明度跨度大的配色还不够。配色越多样，用户越容易将数据与图像联系起来。如果能善加利用色调的变化，就能使非色盲用户更加轻松。

![为可视化数据寻找适合的配色：结合明度与色调多级过渡的数据色板图](https://cdn.victor42.work/posts/2015-11/11-27/1-wgC_dBB1C2w3G6jaSFpZPQ.png)
...
![为可视化数据寻找适合的配色：自然渐变与非自然渐变配色方案对比图](https://cdn.victor42.work/posts/2015-11/11-27/1-lL_koW3jH7nYf6_ZbFx3WA.png)

这是由于我们已经习惯于那些长期存在于自然界中的渐变。在华丽的日落中，我们就能看到明黄色向深紫色的渐变，但却没有哪里能看到淡紫色向深黄色的过渡。

![为可视化数据寻找适合的配色：华丽日落景色中明黄向深紫的自然渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-oIa-7FvHZYgGxPp0ytfY6w.jpeg)

![为可视化数据寻找适合的配色：自然界水体景观中淡绿向深蓝的过渡色](https://cdn.victor42.work/posts/2015-11/11-27/1-PPPHMucunVmHYzFJBJW45Q.jpeg)

![为可视化数据寻找适合的配色：日落海滩景色中明黄向深紫的色彩过渡](https://cdn.victor42.work/posts/2015-11/11-27/1-Jhvmh70U7q8P-_MajshKew.jpeg)
...
![为可视化数据寻找适合的配色：密苏里圆形泉水中浅绿向藏蓝的自然渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-NUUVVX2MpC4Y1_nP8CHjWA.jpeg)

![为可视化数据寻找适合的配色：秋季森林树木中鹅黄向棕红的色彩过渡](https://cdn.victor42.work/posts/2015-11/11-27/1-W5vjfZydrhjBbKQ4R9tl3A.jpeg)

![为可视化数据寻找适合的配色：黄石公园温泉池中浅黄向绿色的自然渐变](https://cdn.victor42.work/posts/2015-11/11-27/1-_dsL23-byBssnWm7aFAKdg.jpeg)
...
![为可视化数据寻找适合的配色：在设计软件中调整渐变叠加并选取色值](https://cdn.victor42.work/posts/2015-11/11-27/1-wgvwormxteQ6jdT4De63Hg.png)
...
![为可视化数据寻找适合的配色：包含极大明度差异的冷色系渐变色板图](https://cdn.victor42.work/posts/2015-11/11-27/1-B29h3NSglI42HGhWZA-5Mg.png)

![为可视化数据寻找适合的配色：包含极大明度差异的暖色系渐变色板图](https://cdn.victor42.work/posts/2015-11/11-27/1--Vgr9hPpUU3PYtg_B4rd2g.png)

![为可视化数据寻找适合的配色：包含极大明度差异的霓虹色系渐变色板](https://cdn.victor42.work/posts/2015-11/11-27/1-pH2QoOf47OqwtG9suWaRJw.png)

冷色、暖色和霓虹色。

## 配色的实际运用

![为可视化数据寻找适合的配色：优秀配色方案在实际柱状图表中的应用图](https://cdn.victor42.work/posts/2015-11/11-27/1.png)

![为可视化数据寻找适合的配色：优秀配色方案在世界地图可视化中的应用图](https://cdn.victor42.work/posts/2015-11/11-27/2.png)

![为可视化数据寻找适合的配色：优秀配色方案在折线趋势图表中的应用图](https://cdn.victor42.work/posts/2015-11/11-27/3.png)
