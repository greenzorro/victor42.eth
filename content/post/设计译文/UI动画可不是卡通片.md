...
![UI动画可不是卡通片：按钮像橡皮绳一样夸张弹动的卡通化UI动画反例](https://cdn.victor42.work/posts/2015-10/10-11/1-KNDtrZZKN5-bNQ7YVB8_fQ.gif)
...
![UI动画可不是卡通片：保存失败通知用300毫秒淡入动效引导用户注意](https://cdn.victor42.work/posts/2015-10/10-11/1-UJdmc7IUuOjJFSNnpUmH0w.gif)
...
![UI动画可不是卡通片：保存失败通知在重复点击后升级为更强烈的晃动动效](https://cdn.victor42.work/posts/2015-10/10-11/1-bX8hBD6PmbjedK0SYzBSlA.gif)
...
![UI动画可不是卡通片：移动端列表卡片展开时保持上下文关系的功能动画](https://cdn.victor42.work/posts/2015-10/10-11/1-YaoMTOLjuUBRrfBATGzSxA.gif)
...
![UI动画可不是卡通片：飞机驾驶舱界面用静态仪表说明关键系统不需要装饰动画](https://cdn.victor42.work/posts/2015-10/10-11/1-s9LTV7aFZeWvN-rTbGAwUA.jpeg)
