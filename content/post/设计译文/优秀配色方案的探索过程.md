...
tags: ["设计", "翻译", "设计师", "配色", "UI", "教程"]
url: /post/3502
---

**[国外设计第133期]**

![苏黎世机场内部宽幅全景，自动扶梯通向登机口，青蓝色玻璃幕墙与暖色灯带形成冷暖对比，作为配色方案的灵感来源照片](https://cdn.victor42.work/posts/2016-05/05-11/1-XWDMzvBFKfF_Mf6ix1nf9A.jpeg)
...
![苏黎世机场E62-67登机口区域，自动扶梯居中对称构图，青蓝色调玻璃窗与混凝土墙面呈现冷峻工业风格，配色提取的原始素材](https://cdn.victor42.work/posts/2016-05/05-11/1-VHoHvr8JQjNoNxcaVA9u2g.jpeg)

*瑞士Zürich-Flughafen的Zurich机场*

首先要做的是从图片中选取一些颜色。目前，我只会选出4种颜色：一种强调色彩、一种浅色、一种深色、还有一种其他颜色。我们之后可以随时回来查看这张图片。

![Sketch取色器从机场照片中提取颜色#CEBEBF，下方展示四种基础配色色块：青绿色、米白色、灰褐色和深墨绿色，构成初始配色方案](https://cdn.victor42.work/posts/2016-05/05-11/1-KTfLVZkGqqb02Tm0lKP6hA.png)
...
![Sketch调色板饱和度探索，三行四列色块分别展示高饱和度、原始饱和度和低饱和度下的青绿、米白、灰褐、深墨绿四种基础色变化](https://cdn.victor42.work/posts/2016-05/05-11/1-hrkOFdrzGPhOIV8GYzpi1A.png)

![Sketch色相偏移实验，三行四列色块展示高色相、原始色相和低色相下的颜色变化，青绿色分别偏移为紫色和橄榄绿，探索配色方案的色相可能性](https://cdn.victor42.work/posts/2016-05/05-11/1-syH0srvgPs9NYU1tlxECqQ.png)

![Sketch应用内置颜色选择器界面，显示十六进制色值65C0C3的青绿色，HSB参数为H:2-10、S:48、B:76，用于精确调节配色方案中的色调](https://cdn.victor42.work/posts/2016-05/05-11/1-fevfYlI9rRjJ5iCSbcZOUQ.png)

### 通过其他工具探索

我们可以使用像[Paletton](http://paletton.com)这样的[在线工具](http://www.sessions.edu/color-calculator)帮助我们发现新的色彩。在本例中，我用了两种不同工具来计算互补色和三色系。

![互补色与三色系配色工具生成的颜色方案，左侧展示原始配色与Triad 1、Triad 2三色系变体，右侧为调整后的版本，底部展示互补色方案，用于扩展配色选择](https://cdn.victor42.work/posts/2016-05/05-11/1--6vH4MJdXVHxr-mvilCvdQ.png)

最后，还可以尝试在配色上叠加40%透明度的白色和黑色。

![在原始四色配色上叠加40%白色和40%黑色的效果对比，三行色块分别展示白色叠加后的浅色调、原始颜色和黑色叠加后的深色调，探索明度变化对配色方案的影响](https://cdn.victor42.work/posts/2016-05/05-11/1--vyvYrSOi8LJNYVm4Oxkww.png)
...
![配色方案探索全景图，左侧展示以黄色作为强调色的选择过程，右侧汇总Hue色相、Grayscale Overlay灰度叠加、Triadic三色系、Saturation饱和度、Compl互补色等所有探索生成的色板变体](https://cdn.victor42.work/posts/2016-05/05-11/1-Bx8AvMNcXPWljOgg_bi3HA.png)

这整个过程帮助我们生成了相当多不同的颜色。如果我把最初的配色去掉，它们就是这些：

![所有探索过程生成的色彩样品汇总，左上角为苏黎世机场原始照片和四色基础配色，下方大网格展示色相、饱和度、三色系、互补色、灰度叠加等所有方法产生的大量颜色变体](https://cdn.victor42.work/posts/2016-05/05-11/1-yAmiyOuq-n8bNnXzhkPZPQ.png)
...
![配色方案打磨过程，色块以类似俄罗斯方块的方式错落排列，展示从大量候选颜色中筛选、搭配和组合最终配色的决策过程](https://cdn.victor42.work/posts/2016-05/05-11/1-NhYQLJJ2HC1dkaNkG49bWQ.png)

*打磨配色（这不是在玩俄罗斯方块）*

纠结一阵子后，得到最终的配色方案：

![最终确定的配色方案，包含Primary主色Teal青绿、Bright Teal亮青绿、White白、Cream奶油白、Grey灰、Black黑，以及Secondary辅色Tomato番茄红、Lime青柠绿、Yellow黄、Pink粉、Purple紫、Dark Teal深青绿等共14种颜色](https://cdn.victor42.work/posts/2016-05/05-11/1-tBCSRhffACvsNF2eyt4HNQ.png)
