...
![](http://qiniu.colacdn.com/img/posts/2017-04/04-05/018-1200x675.jpg)        
...
那么你的这款改变世界的应用，肯定也需要一个图标，[猫咪](https://icons8.com/web-app/for/all/cat)图标。这时候Icons8就派上了用场。
 ...
 ![cat-search](http://qiniu.colacdn.com/img/posts/2017-04/04-05/cat-search.png) 
...
试着搜索一下[工作](https://icons8.com/web-app/for/all/work)图标，你就能了解我们的搜索算法的厉害之处，它能囊括所有几乎能与“工作”沾上边的图标。
 ...
 ![work-search](http://qiniu.colacdn.com/img/posts/2017-04/04-05/work-search.png) 

问题是，每个人对于相关与不相关都有自己的理解。更要命的是，即使同一个人，在某些因素影响下也会对一个图标的相关与不相关做出不同的判断，比如说文字标签。给图标加上文字标签，或许就能改变人们的认知。

我们不知道怎么应对这种情况，因为我们有两种显示模式：

 ![icon-with-without-label](http://qiniu.colacdn.com/img/posts/2017-04/04-05/icon-with-without-label.png) 
...
……然后指出他们觉得离谱的结果：
 ...
 ![dog-irrelevant](http://qiniu.colacdn.com/img/posts/2017-04/04-05/dog-irrelevant.png) 

我邀请部分人用**纯图标**模式搜索，另一些用**图标+文字**模式。我绘制了一张表格记录所有数据——对于不同模式下的每个图标，参与者指出了多少个离谱的搜索结果。

 ![table-results](http://qiniu.colacdn.com/img/posts/2017-04/04-05/table-results.png) 
...
假如你搜索[盒子](https://icons8.com/web-app/for/all/box)图标，在搜索结果中出现了这样的图形：
 ...
 ![box-icon-no-label](http://qiniu.colacdn.com/img/posts/2017-04/04-05/box-icon-no-label.png) 

此时，相关与否其实是受文字标签影响的。

 ![box-icon-label](http://qiniu.colacdn.com/img/posts/2017-04/04-05/box-icon-label.png) 

【译者注：在英文中，Box是盒子，而Boxing是拳击】

 ![line-search-1](http://qiniu.colacdn.com/img/posts/2017-04/04-05/line-search-1.png) 
...
我们再搜索一次[盒子](https://icons8.com/web-app/for/all/box)。在各种搜索结果中发现了这个图标：
 ...
 ![monitor-icon-no-label](http://qiniu.colacdn.com/img/posts/2017-04/04-05/monitor-icon-no-label.png) 

许多参与者认为它是相关的，因为它有一个盒子的外形。但这是纯图标的情况：

 ![monitor-icon-label](http://qiniu.colacdn.com/img/posts/2017-04/04-05/monitor-icon-label.png) 
