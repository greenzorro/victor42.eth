...
![Apple Watch设计入门：关于是查看应用数据或与之的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/1-watchkit-app.jpg)
...
![Apple Watch设计入门：关于层级式非常适合相对复的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/2-hierarchical.jpg)

**层级式**非常适合相对复杂的应用，类似很多现存iPhone应用，用户在其中需要进行一系列的选择，然后到达结束界面。牢记Apple预期用户在10秒内突击使用手表，所以别在手表上照搬现成应用，应该将它升华。

![Apple Watch设计入门：关于页面式通过横向滑动让的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/3-page-based.jpg)
...
![Apple Watch设计入门：关于是一系列可浏览的内容的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/4-glance.jpg)
...
![Apple Watch设计入门：关于最后基于一些模版所以的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/5-glance-templates.jpg)

最后，Glance基于一些模版。所以你的设计要选择一种最能体现数据意义的形式。Apple提供了一系列模版，适用于上半屏和下半屏。

### 通知

![Apple Watch设计入门：关于应用有两种通知状态分的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/6-notifications.jpg)
...
![Apple Watch设计入门：关于界面包含应用图标应用的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/7-short-look.jpg)

short-look界面包含应用图标、应用名称和通知的标题。由于标题是你唯一能控制的东西，它需要为通知的内容提供简短的提示。

![Apple Watch设计入门：关于所有应用的界面结构都的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/8-long-look.jpg)
...
![Apple Watch设计入门：关于应用可以通过滚轮来滚的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/9-digital-crown.jpg)

应用可以通过滚轮来滚动，不会像手指滑动那样挡住屏幕。滚轮尤其适用于长页面的滚动。

### 按压

![Apple Watch设计入门：关于的屏幕可以区分点击和的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/10-force-touch.jpg)
...
![Apple Watch设计入门：关于有两种尺寸和小屏幕尺的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/11-layout.jpg)
...
![Apple Watch设计入门：关于设计应用时建议用黑色的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/12-full-width.jpg)
...
![Apple Watch设计入门：关于每个应用可以定义一个的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/13-key-color.jpg)

每个应用可以定义一个“主色”，它会显示在状态栏的标题和通知的应用名称上。还可以自定义long-look通知的顶栏颜色。

## 动画

![Apple Watch设计入门：国外优秀设计官方网站的动画页面版式布局](http://designmodo.com/wp-content/uploads/2015/03/14-dm-zoom.gif)
...
![Apple Watch设计入门：关于至多显示个操作项它表的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/15-context-menu.jpg)
...
![Apple Watch设计入门：关于对于你得给每个图标提的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/16-menu-image-sizes.jpg)

对于Context menu，你得给每个图标提供两种大小的图片。在42mm的手表上，图标的线宽通常比38mm版多1像素。

## 字体

![Apple Watch设计入门：国外优秀设计官方网站的字体页面版式布1](http://designmodo.com/wp-content/uploads/2015/03/17-font.jpg)
...
![Apple Watch设计入门：关于像主屏图标一样也需要的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/18-home-icons.jpg)
...
![Apple Watch设计入门：关于设计不同尺寸的图标来的视觉展示图](http://designmodo.com/wp-content/uploads/2015/03/19-app-icon-size.jpg)
